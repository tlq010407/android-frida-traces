...
public class ID3v2TagHeader {
        ...
        if (i == 2) {
            ...
            if ((b2 & 64) != 0) {
                if (i == 3) {
                    ...
                    syncsafeInt = iD3v2DataInput.readSyncsafeInt() - 4;
                }
                iD3v2DataInput.skipFully(syncsafeInt);
            }
    ...
    public ID3v2TagBody tagBody(InputStream inputStream) throws IOException, ID3v2Exception {
        ...
        return new ID3v2TagBody(new ByteArrayInputStream(fully, 0, i2), this.headerSize, i2, this);
    }
