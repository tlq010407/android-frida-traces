    ...
    public void setConfig(double d, double d2, int i, long j) {
        ...
        try {
            ...
            try {
                ...
                nativeSetConfig(j2, d, d2, i, z, z, true, logFilePath, (BuildVars.DEBUG_VERSION || !z) ? null : getLogFilePath("voipStats"), BuildVars.DEBUG_VERSION);
            }
        ...
        boolean z3 = zIsAvailable || !VoIPServerConfig.getBoolean("use_system_aec", true);
        boolean z4 = zIsAvailable2 || !VoIPServerConfig.getBoolean("use_system_ns", true);
        if (BuildVars.DEBUG_VERSION) {
            logFilePath = getLogFilePath(j);
        } else {
            logFilePath = getLogFilePath("voip" + j);
        }
        nativeSetConfig(j22, d, d2, i, z3, z4, true, logFilePath, (BuildVars.DEBUG_VERSION || !z2) ? null : getLogFilePath("voipStats"), BuildVars.DEBUG_VERSION);
    }
