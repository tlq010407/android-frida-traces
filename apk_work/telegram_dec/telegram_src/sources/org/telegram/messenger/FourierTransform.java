...
public abstract class FourierTransform {
    ...
    public static class FFT extends FourierTransform {
        ...
        public void setBand(int i, float f) {
            ...
            float[] fArr = this.real;
            float f2 = fArr[i];
            if (f2 == BitmapDescriptorFactory.HUE_RED && this.imag[i] == BitmapDescriptorFactory.HUE_RED) {
                fArr[i] = f;
                this.spectrum[i] = f;
            } else {
    ...
    protected void fillSpectrum() {
        ...
        while (true) {
            ...
            float fPow = i6 == 0 ? BitmapDescriptorFactory.HUE_RED : (this.sampleRate / 2) / ((float) Math.pow(2.0d, r5 - i6));
