    ...
    */
    public long open(DataSpec dataSpec) {
        ...
        if (Util.isLocalFileUri(uri)) {
            ...
            contentDataSource = (path == null || !path.startsWith("/android_asset/")) ? uri.getPath().endsWith(".enc") ? getEncryptedFileDataSource() : getFileDataSource() : getAssetDataSource();
        } else if ("tg".equals(scheme)) {
            contentDataSource = getStreamDataSource();
        } else if (!SCHEME_ASSET.equals(scheme)) {
            contentDataSource = "content".equals(scheme) ? getContentDataSource() : SCHEME_RTMP.equals(scheme) ? getRtmpDataSource() : RemoteMessageConst.DATA.equals(scheme) ? getDataSchemeDataSource() : SCHEME_RAW.equals(scheme) ? getRawResourceDataSource() : this.baseDataSource;
        }
