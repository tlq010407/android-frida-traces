...
public enum BotWebViewVibrationEffect {
    ...
    public VibrationEffect getVibrationEffectForOreo() {
        if (this.vibrationEffect == null) {
            this.vibrationEffect = !AndroidUtilities.getVibrator().hasAmplitudeControl() ? VibrationEffect.createWaveform(this.fallbackTimings, -1) : VibrationEffect.createWaveform(this.timings, this.amplitudes, -1);
        }
