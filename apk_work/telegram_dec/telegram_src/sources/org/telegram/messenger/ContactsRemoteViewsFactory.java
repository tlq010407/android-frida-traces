        ...
        while (i4 < 2) {
            ...
            if (i5 >= this.dids.size()) {
                ...
                if (DialogObject.isUserDialog(l.longValue())) {
                    ...
                    firstName = LocaleController.getString(i3);
                ...
                remoteViews3.setTextViewText(i4 == 0 ? R.id.contacts_widget_item_text1 : R.id.contacts_widget_item_text2, firstName);
                ...
                remoteViews3.setImageViewBitmap(i4 == 0 ? R.id.contacts_widget_item_avatar1 : R.id.contacts_widget_item_avatar2, bitmapCreateBitmap);
                ...
                bundle2.putLong(str, jLongValue);
