...
public class ExternalActionActivity extends Activity implements INavigationLayout.INavigationLayoutDelegate {
    ...
    public /* synthetic */ void lambda$handleIntent$10(int[] iArr, final int i, final AlertDialog alertDialog, final TL_account$getAuthorizationForm tL_account$getAuthorizationForm, final String str, final String str2, TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        if (tL_account$authorizationForm == null) {
            ...
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(new TL_account$getPassword(), new RequestDelegate() { // from class: org.telegram.ui.ExternalActionActivity$$ExternalSyntheticLambda7
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                    this.f$0.lambda$handleIntent$7(alertDialog, i, tL_account$authorizationForm, tL_account$getAuthorizationForm, str, str2, tLObject2, tL_error2);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$handleIntent$6(AlertDialog alertDialog, TLObject tLObject, int i, TL_account$authorizationForm tL_account$authorizationForm, TL_account$getAuthorizationForm tL_account$getAuthorizationForm, String str, String str2) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        ...
        if (tLObject != null) {
            ...
            PassportActivity passportActivity = new PassportActivity(5, tL_account$getAuthorizationForm.bot_id, tL_account$getAuthorizationForm.scope, tL_account$getAuthorizationForm.public_key, str, str2, (String) null, tL_account$authorizationForm, (TL_account$Password) tLObject);
    ...
    public /* synthetic */ void lambda$handleIntent$7(final AlertDialog alertDialog, final int i, final TL_account$authorizationForm tL_account$authorizationForm, final TL_account$getAuthorizationForm tL_account$getAuthorizationForm, final String str, final String str2, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ExternalActionActivity$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$handleIntent$6(alertDialog, tLObject, i, tL_account$authorizationForm, tL_account$getAuthorizationForm, str, str2);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$handleIntent$9(AlertDialog alertDialog, final TLRPC.TL_error tL_error) {
        ...
        try {
            ...
            if ("APP_VERSION_OUTDATED".equals(tL_error.text)) {
                ...
                intentPutExtra = new Intent().putExtra("error", tL_error.text);
            } else {
    ...
    */
    protected boolean handleIntent(final Intent intent, final boolean z, final boolean z2, final boolean z3, final int i, int i2) {
        ...
        if ("org.telegram.passport.AUTHORIZE".equals(intent.getAction())) {
            ...
            tL_account$getAuthorizationForm.bot_id = longExtra;
            tL_account$getAuthorizationForm.scope = intent.getStringExtra("scope");
            tL_account$getAuthorizationForm.public_key = intent.getStringExtra("public_key");
            if (longExtra == 0 || ((TextUtils.isEmpty(stringExtra2) && TextUtils.isEmpty(stringExtra)) || TextUtils.isEmpty(tL_account$getAuthorizationForm.scope) || TextUtils.isEmpty(tL_account$getAuthorizationForm.public_key))) {
                finish();
                return false;
            }
            final int[] iArr = {0};
            ...
            alertDialog.show();
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(tL_account$getAuthorizationForm, new RequestDelegate() { // from class: org.telegram.ui.ExternalActionActivity$$ExternalSyntheticLambda6
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$handleIntent$10(iArr, i, alertDialog, tL_account$getAuthorizationForm, stringExtra2, stringExtra, tLObject, tL_error);
                }
            }, 10);
