...
public class LiteModeSettingsActivity extends BaseFragment {
    ...
    private class Adapter extends AdapterWithDiffUtils {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws IOException {
            ...
            themedDrawableByKey = Theme.getThemedDrawableByKey(context, i2, Theme.key_windowBackgroundGrayShadow);
            textInfoPrivacyCell.setBackground(themedDrawableByKey);
        }
    ...
    class PowerSaverSlider extends FrameLayout {
        ...
        public PowerSaverSlider(Context context) throws IOException {
            ...
            addView(this.headerLayout, LayoutHelper.createFrame(-1, -2.0f, 55, 21.0f, 17.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.seekBarView, LayoutHelper.createFrame(-1, 44.0f, 48, 6.0f, 68.0f, 6.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.valuesView, LayoutHelper.createFrame(-1, -2.0f, 55, 21.0f, 52.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
                ...
                public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) throws IOException {
                    ...
                    if (powerSaverLevel <= 0) {
                        ...
                        if (powerSaverLevel < 100) {
                            string = LocaleController.formatString(R.string.AccDescrLiteBatteryWhenBelow, Integer.valueOf(Math.round(powerSaverLevel)));
                            sb.append(string);
        ...
        public void update() throws IOException {
            ...
            if (powerSaverLevel <= 0) {
                ...
                if (powerSaverLevel < 100) {
                    ...
                    animatedTextView = this.middleTextView;
                    charSequenceReplaceCharSequence = AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f))), this.batteryText));
                    animatedTextView.setText(charSequenceReplaceCharSequence, !LocaleController.isRTL);
            ...
            charSequenceReplaceCharSequence = LocaleController.getString(i);
            animatedTextView.setText(charSequenceReplaceCharSequence, !LocaleController.isRTL);
            this.headerOnView.setText(LocaleController.getString(!LiteMode.isPowerSaverApplied() ? R.string.LiteBatteryEnabled : R.string.LiteBatteryDisabled).toUpperCase());
            updateHeaderOnVisibility(powerSaverLevel <= 0 && powerSaverLevel < 100);
            updateOnActive(powerSaverLevel < 100);
    ...
    private class SwitchCell extends FrameLayout {
        ...
        public SwitchCell(Context context) {
            ...
            addView(this.imageView, LayoutHelper.createFrame(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 20.0f, BitmapDescriptorFactory.HUE_RED, 20.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.textViewLayout, LayoutHelper.createFrame(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 64.0f, BitmapDescriptorFactory.HUE_RED, 8.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.switchView, LayoutHelper.createFrame(37, 50.0f, (LocaleController.isRTL ? 3 : 5) | 16, 19.0f, BitmapDescriptorFactory.HUE_RED, 19.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(checkBox22, LayoutHelper.createFrame(21, 21.0f, (z ? 5 : 3) | 16, z ? BitmapDescriptorFactory.HUE_RED : 64.0f, BitmapDescriptorFactory.HUE_RED, z ? 64.0f : BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
            setFocusable(true);
        }

        /* JADX WARN: Removed duplicated region for block: B:21:0x0031 A[PHI: r1
          0x0031: PHI (r1v5 int) = (r1v2 int), (r1v12 int) binds: [B:20:0x002f, B:11:0x001e] A[DONT_GENERATE, DONT_INLINE]] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        private int preprocessFlagsCount(int i) {
            ...
            if (zIsPremium) {
                ...
                if ((i & LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD_NOT_PREMIUM) > 0) {
                    iBitCount--;
                }
            } else {
                if ((i & 16) > 0) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (LocaleController.isRTL) {
                ...
                if (this.needDivider) {
                    canvas.drawLine((getMeasuredWidth() - AndroidUtilities.dp(64.0f)) + (this.textView.getTranslationX() < BitmapDescriptorFactory.HUE_RED ? AndroidUtilities.dp(-32.0f) : 0), getMeasuredHeight() - 1, BitmapDescriptorFactory.HUE_RED, getMeasuredHeight() - 1, Theme.dividerPaint);
                    return;
                }
                return;
            }
