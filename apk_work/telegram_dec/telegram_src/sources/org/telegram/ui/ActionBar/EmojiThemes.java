...
public class EmojiThemes {
    ...
    public static /* synthetic */ void lambda$loadWallpaperImage$1(final ResultCallback resultCallback, final long j, TLRPC.WallPaper wallPaper, final int i, Bitmap bitmap) {
        ...
        imageReceiver.setImage(forDocument, ((int) (iMin / AndroidUtilities.density)) + "_" + ((int) (Math.max(point2.x, point2.y) / AndroidUtilities.density)) + "_f", null, ".jpg", wallPaper, 1);
        imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.ActionBar.EmojiThemes$$ExternalSyntheticLambda2
            ...
            public final void didSetImage(ImageReceiver imageReceiver2, boolean z, boolean z2, boolean z3) {
                EmojiThemes.lambda$loadWallpaperImage$0(resultCallback, j, i, imageReceiver2, z, z2, z3);
            }
    ...
    public static void loadWallpaperImage(final int i, final long j, final TLRPC.WallPaper wallPaper, final ResultCallback resultCallback) {
        ChatThemeController.getInstance(i).getWallpaperBitmap(j, new ResultCallback() { // from class: org.telegram.ui.ActionBar.EmojiThemes$$ExternalSyntheticLambda0
            ...
            public final void onComplete(Object obj) {
                EmojiThemes.lambda$loadWallpaperImage$1(resultCallback, j, wallPaper, i, (Bitmap) obj);
            }
    ...
    public SparseIntArray getPreviewColors(int i, int i2) {
        ...
        if (themeInfo == null) {
            ...
            if (theme != null) {
                ...
                themeAccentCreateNewAccent = themeInfo.createNewAccent(tlTheme, i, true, settingsIndex);
                if (themeAccentCreateNewAccent != null) {
        ...
        while (true) {
            try {
                ...
                int i5 = iArr[i4];
                int iIndexOfKey = themeFileValues.indexOfKey(i5);
                if (iIndexOfKey >= 0 || ((i3 = fallbackKeys.get(i5, -1)) >= 0 && (iIndexOfKey = themeFileValues.indexOfKey(i3)) >= 0)) {
                    sparseIntArray2.put(i5, themeFileValues.valueAt(iIndexOfKey));
                }
                i4++;
            } catch (Exception e) {
                FileLog.e(e);
