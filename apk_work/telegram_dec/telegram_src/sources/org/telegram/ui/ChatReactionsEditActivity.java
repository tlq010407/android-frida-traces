    ...
    public View createView(final Context context) {
        ...
        RecyclerView.Adapter adapter = new RecyclerView.Adapter() { // from class: org.telegram.ui.ChatReactionsEditActivity.2
            ...
            public int getItemCount() {
                ...
                boolean zIsEmpty = chatReactionsEditActivity.chatReactions.isEmpty();
                if (z) {
                    return (zIsEmpty ? 0 : ChatReactionsEditActivity.this.availableReactions.size() + 1) + 1;
                }
                return (zIsEmpty ? 0 : ChatReactionsEditActivity.this.availableReactions.size() + 1) + 2;
            }
