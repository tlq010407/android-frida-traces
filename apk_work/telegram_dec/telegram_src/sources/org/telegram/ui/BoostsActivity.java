...
public class BoostsActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    class AnonymousClass5 extends FrameLayout {
        ...
        AnonymousClass5(Context context) {
            ...
            linearLayout.addView(headerButtonView, LayoutHelper.createLinear(-2, -2, 6.0f, BitmapDescriptorFactory.HUE_RED, 6.0f, BitmapDescriptorFactory.HUE_RED));
            if (MessagesController.getInstance(BoostsActivity.this.currentAccount).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(BoostsActivity.this.currentChat)) {
                linearLayout.addView(headerButtonView2, LayoutHelper.createLinear(-2, -2, 6.0f, BitmapDescriptorFactory.HUE_RED, 6.0f, BitmapDescriptorFactory.HUE_RED));
            }
            linearLayout.addView(headerButtonView3, LayoutHelper.createLinear(-2, -2, 6.0f, BitmapDescriptorFactory.HUE_RED, 6.0f, BitmapDescriptorFactory.HUE_RED));
            addView(linearLayout, LayoutHelper.createFrame(-2, -2.0f, 1, BitmapDescriptorFactory.HUE_RED, 19.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        }
    ...
    private class HeaderButtonView extends FrameLayout {
        ...
        public HeaderButtonView(Context context) {
            ...
            addView(textView, LayoutHelper.createFrame(-2, -2.0f, 1, BitmapDescriptorFactory.HUE_RED, 25.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
    ...
    public /* synthetic */ void lambda$loadStatistic$0(TL_stories$TL_premium_boostsStatus tL_stories$TL_premium_boostsStatus) {
        ...
        this.progressLayout.animate().alpha(BitmapDescriptorFactory.HUE_RED).setDuration(100L).setStartDelay(0L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.BoostsActivity.2
    ...
    public /* synthetic */ void lambda$loadStatistic$1(final TL_stories$TL_premium_boostsStatus tL_stories$TL_premium_boostsStatus) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.BoostsActivity$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadStatistic$0(tL_stories$TL_premium_boostsStatus);
            }
        });
    }
    ...
    public void createEmptyView(Context context) {
        ...
        }, LayoutHelper.createLinear(100, 100, 17, 0, R.styleable.AppCompatTheme_windowFixedHeightMajor, 0, 0));
