...
public class ContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.ContactsActivity$8, reason: invalid class name */
    class AnonymousClass8 implements RecyclerListView.OnItemLongClickListener {
        ...
        public /* synthetic */ void lambda$onItemClick$2(String str, long j, TLRPC.User user) {
            ...
            BulletinFactory.of(ContactsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, strTrim))).show();
        }
        ...
        public /* synthetic */ void lambda$onItemClick$3(String str, long j, TLRPC.User user) {
            ...
            BulletinFactory.of(ContactsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, strTrim))).show();
        }
        ...
        public boolean onItemClick(View view, int i) {
            if (ContactsActivity.this.listView.getAdapter() == ContactsActivity.this.listViewAdapter) {
                ...
                if (ContactsActivity.this.listViewAdapter.hasStories && sectionForPosition == 1 && (view instanceof UserCell)) {
                    ...
                    }).addIf(zAreStoriesNotMuted, R.drawable.msg_mute, LocaleController.getString(R.string.NotificationsStoryMute), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onItemClick$2(sharedPrefKey, dialogId, user);
                        }
                    }).addIf(!zAreStoriesNotMuted, R.drawable.msg_unmute, LocaleController.getString(R.string.NotificationsStoryUnmute), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onItemClick$3(sharedPrefKey, dialogId, user);
                        }
                    });
                    itemOptionsAddIf.add(R.drawable.msg_viewintopic, LocaleController.getString(R.string.ShowInChats), new Runnable() { // from class: org.telegram.ui.ContactsActivity$8$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        if (z2) {
            for (int i3 = 0; i3 < 6; i3++) {
                ...
                if (i3 == 0) {
                    ...
                    ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(rLottieImageView2, (Property<RLottieImageView, Float>) property, 1.0f, 0.9f);
                    RLottieImageView rLottieImageView3 = this.floatingButton;
                    Property property2 = View.SCALE_Y;
                    animatorSet3.playTogether(objectAnimatorOfFloat, ObjectAnimator.ofFloat(rLottieImageView3, (Property<RLottieImageView, Float>) property2, 1.0f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property, 1.0f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property2, 1.0f, 0.9f));
                    ...
                    if (i3 == 1) {
                        ...
                        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(rLottieImageView4, (Property<RLottieImageView, Float>) property3, 0.9f, 1.06f);
                        RLottieImageView rLottieImageView5 = this.floatingButton;
                        Property property4 = View.SCALE_Y;
                        animatorSet3.playTogether(objectAnimatorOfFloat2, ObjectAnimator.ofFloat(rLottieImageView5, (Property<RLottieImageView, Float>) property4, 0.9f, 1.06f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property3, 0.9f, 1.06f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property4, 0.9f, 1.06f));
                        j = (long) (0.3617021f * duration);
                    } else if (i3 == 2) {
                        RLottieImageView rLottieImageView6 = this.floatingButton;
                        Property property5 = View.SCALE_X;
                        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(rLottieImageView6, (Property<RLottieImageView, Float>) property5, 1.06f, 0.9f);
                        RLottieImageView rLottieImageView7 = this.floatingButton;
                        Property property6 = View.SCALE_Y;
                        animatorSet3.playTogether(objectAnimatorOfFloat3, ObjectAnimator.ofFloat(rLottieImageView7, (Property<RLottieImageView, Float>) property6, 1.06f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property5, 1.06f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property6, 1.06f, 0.9f));
                        ...
                        if (i3 == 3) {
                            ...
                            ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(rLottieImageView8, (Property<RLottieImageView, Float>) property7, 0.9f, 1.03f);
                            RLottieImageView rLottieImageView9 = this.floatingButton;
                            Property property8 = View.SCALE_Y;
                            animatorSet3.playTogether(objectAnimatorOfFloat4, ObjectAnimator.ofFloat(rLottieImageView9, (Property<RLottieImageView, Float>) property8, 0.9f, 1.03f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property7, 0.9f, 1.03f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property8, 0.9f, 1.03f));
                        } else {
                            ...
                            if (i3 == 4) {
                                ...
                                fArr[0] = 1.03f;
                                fArr[1] = 0.98f;
                                ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(rLottieImageView10, (Property<RLottieImageView, Float>) property9, fArr);
                                RLottieImageView rLottieImageView11 = this.floatingButton;
                                Property property10 = View.SCALE_Y;
                                animatorSet3.playTogether(objectAnimatorOfFloat5, ObjectAnimator.ofFloat(rLottieImageView11, (Property<RLottieImageView, Float>) property10, 1.03f, 0.98f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property9, 1.03f, 0.98f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property10, 1.03f, 0.98f));
                            } else {
                                ObjectAnimator objectAnimatorOfFloat6 = ObjectAnimator.ofFloat(rLottieImageView10, (Property<RLottieImageView, Float>) property9, fArr);
                                RLottieImageView rLottieImageView12 = this.floatingButton;
                                Property property11 = View.SCALE_Y;
                                animatorSet3.playTogether(objectAnimatorOfFloat6, ObjectAnimator.ofFloat(rLottieImageView12, (Property<RLottieImageView, Float>) property11, 0.98f, 1.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property9, 0.98f, 1.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property11, 0.98f, 1.0f));
            ...
            for (int i4 = 0; i4 < 5; i4++) {
                ...
                if (i4 == 0) {
                    ...
                    ObjectAnimator objectAnimatorOfFloat7 = ObjectAnimator.ofFloat(rLottieImageView13, (Property<RLottieImageView, Float>) property12, 1.0f, 0.9f);
                    RLottieImageView rLottieImageView14 = this.floatingButton;
                    Property property13 = View.SCALE_Y;
                    animatorSet4.playTogether(objectAnimatorOfFloat7, ObjectAnimator.ofFloat(rLottieImageView14, (Property<RLottieImageView, Float>) property13, 1.0f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property12, 1.0f, 0.9f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property13, 1.0f, 0.9f));
                    ...
                    if (i4 == 1) {
                        ...
                        ObjectAnimator objectAnimatorOfFloat8 = ObjectAnimator.ofFloat(rLottieImageView15, (Property<RLottieImageView, Float>) property14, 0.9f, 1.06f);
                        RLottieImageView rLottieImageView16 = this.floatingButton;
                        Property property15 = View.SCALE_Y;
                        animatorSet4.playTogether(objectAnimatorOfFloat8, ObjectAnimator.ofFloat(rLottieImageView16, (Property<RLottieImageView, Float>) property15, 0.9f, 1.06f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property14, 0.9f, 1.06f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property15, 0.9f, 1.06f));
                        f = 0.22222222f;
                    } else if (i4 == 2) {
                        RLottieImageView rLottieImageView17 = this.floatingButton;
                        Property property16 = View.SCALE_X;
                        ObjectAnimator objectAnimatorOfFloat9 = ObjectAnimator.ofFloat(rLottieImageView17, (Property<RLottieImageView, Float>) property16, 1.06f, 0.92f);
                        RLottieImageView rLottieImageView18 = this.floatingButton;
                        Property property17 = View.SCALE_Y;
                        animatorSet4.playTogether(objectAnimatorOfFloat9, ObjectAnimator.ofFloat(rLottieImageView18, (Property<RLottieImageView, Float>) property17, 1.06f, 0.92f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property16, 1.06f, 0.92f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property17, 1.06f, 0.92f));
                        animatorSet4.setDuration((long) (0.19444445f * duration));
                        ...
                        ObjectAnimator objectAnimatorOfFloat10 = ObjectAnimator.ofFloat(rLottieImageView19, (Property<RLottieImageView, Float>) property18, 0.92f, 1.02f);
                        RLottieImageView rLottieImageView20 = this.floatingButton;
                        Property property19 = View.SCALE_Y;
                        animatorSet4.playTogether(objectAnimatorOfFloat10, ObjectAnimator.ofFloat(rLottieImageView20, (Property<RLottieImageView, Float>) property19, 0.92f, 1.02f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property18, 0.92f, 1.02f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property19, 0.92f, 1.02f));
                        f = 0.25f;
                    } else {
                        RLottieImageView rLottieImageView21 = this.floatingButton;
                        Property property20 = View.SCALE_X;
                        ObjectAnimator objectAnimatorOfFloat11 = ObjectAnimator.ofFloat(rLottieImageView21, (Property<RLottieImageView, Float>) property20, 1.02f, 1.0f);
                        RLottieImageView rLottieImageView22 = this.floatingButton;
                        Property property21 = View.SCALE_Y;
                        animatorSet4.playTogether(objectAnimatorOfFloat11, ObjectAnimator.ofFloat(rLottieImageView22, (Property<RLottieImageView, Float>) property21, 1.02f, 1.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property20, 1.02f, 1.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) property21, 1.02f, 1.0f));
    ...
    public void performSelectedContactsDelete() {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda9
            ...
            public final void onClick(AlertDialog alertDialog, int i2) {
                this.f$0.lambda$performSelectedContactsDelete$4(alertDialog, i2);
            }
        });
    ...
    */
    public View createView(Context context) {
        ...
        actionBarMenuCreateActionMode.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
        ...
        actionBarMenuCreateActionMode.addView(this.selectedContactsCountTextView, LayoutHelper.createLinear(0, -1, 1.0f, 72, 0, 0, 0));
        this.selectedContactsCountTextView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda4
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ContactsActivity.lambda$createView$0(view, motionEvent);
            }
        });
        this.deleteItem = actionBarMenuCreateActionMode.addItemWithWidth(100, R.drawable.msg_delete, AndroidUtilities.dp(54.0f), LocaleController.getString(R.string.Delete));
        ...
        final ActionBarMenuItem actionBarMenuItemSearchListener = actionBarMenuCreateMenu.addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ContactsActivity.2
        ...
        if (!this.createSecretChat && !this.returnAsResult) {
            ActionBarMenuItem actionBarMenuItemAddItem = actionBarMenuCreateMenu.addItem(1, this.sortByName ? R.drawable.msg_contacts_time : R.drawable.msg_contacts_name);
        ...
        ContactsAdapter contactsAdapter = new ContactsAdapter(context, this, this.onlyUsers ? 1 : 0, this.needPhonebook, this.ignoreUsers, this.selectedContacts, i2, false) { // from class: org.telegram.ui.ContactsActivity.4
            /* JADX WARN: Removed duplicated region for block: B:13:0x0036 A[PHI: r2
              0x0036: PHI (r2v7 org.telegram.ui.Components.RecyclerListView) = (r2v6 org.telegram.ui.Components.RecyclerListView), (r2v11 org.telegram.ui.Components.RecyclerListView) binds: [B:12:0x0034, B:9:0x002b] A[DONT_GENERATE, DONT_INLINE]] */
            /* JADX WARN: Removed duplicated region for block: B:14:0x0038 A[PHI: r2
              0x0038: PHI (r2v9 org.telegram.ui.Components.RecyclerListView) = (r2v6 org.telegram.ui.Components.RecyclerListView), (r2v11 org.telegram.ui.Components.RecyclerListView) binds: [B:12:0x0034, B:9:0x002b] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.ContactsActivity.5
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), ((BaseFragment) ContactsActivity.this).actionBar.getMeasuredHeight(), this.actionBarPaint);
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda5
            ...
            public final void onItemClick(View view, int i4, float f, float f2) {
                this.f$0.lambda$createView$2(i2, view, i4, f, f2);
            }
        });
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ContactsActivity.9
            ...
            public void onScrolled(RecyclerView recyclerView, int i4, int i5) {
                ...
                if (ContactsActivity.this.prevPosition == iFindFirstVisibleItemPosition) {
                    ...
                    z2 = true;
                    z = iFindFirstVisibleItemPosition > ContactsActivity.this.prevPosition;
                }
                if (z2 && ContactsActivity.this.scrollUpdated && (z || this.scrollingManually)) {
                    ContactsActivity.this.hideFloatingButton(z);
                }
                ContactsActivity.this.prevPosition = iFindFirstVisibleItemPosition;
        ...
        if (!this.createSecretChat && !this.returnAsResult) {
            ...
            frameLayout.addView(frameLayout2, LayoutHelper.createFrame(i5, f, (z ? 3 : 5) | 80, z ? 4.0f : BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, z ? BitmapDescriptorFactory.HUE_RED : 4.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            this.floatingButton.setBackground(drawableCreateSimpleSelectorCircleDrawable);
            ...
            this.floatingButtonContainer.addView(this.floatingButton, LayoutHelper.createFrame(i4 >= 21 ? 56 : 60, i4 >= 21 ? 56 : 60, 51, 10.0f, 6.0f, 10.0f, BitmapDescriptorFactory.HUE_RED));
        }
    ...
    public AnimatorSet onCustomTransitionAnimation(final boolean z, final Runnable runnable) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ContactsActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onCustomTransitionAnimation$11(animatorSet, z2, z, view3);
            }
        }, 50L);
        return animatorSet;
    }
