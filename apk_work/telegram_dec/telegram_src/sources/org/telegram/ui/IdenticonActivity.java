...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateEmojiButton(boolean z) {
        ...
        if (z) {
            ...
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.emojiTextView, "alpha", this.emojiSelected ? 1.0f : BitmapDescriptorFactory.HUE_RED);
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this.codeTextView, "alpha", this.emojiSelected ? BitmapDescriptorFactory.HUE_RED : 1.0f);
            ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(this.emojiTextView, "scaleX", this.emojiSelected ? 1.0f : BitmapDescriptorFactory.HUE_RED);
            ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this.emojiTextView, "scaleY", this.emojiSelected ? 1.0f : BitmapDescriptorFactory.HUE_RED);
            ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(this.codeTextView, "scaleX", this.emojiSelected ? BitmapDescriptorFactory.HUE_RED : 1.0f);
            TextView textView = this.codeTextView;
            if (!this.emojiSelected) {
                f = 1.0f;
            }
            animatorSet2.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, objectAnimatorOfFloat3, objectAnimatorOfFloat4, objectAnimatorOfFloat5, ObjectAnimator.ofFloat(textView, "scaleY", f));
