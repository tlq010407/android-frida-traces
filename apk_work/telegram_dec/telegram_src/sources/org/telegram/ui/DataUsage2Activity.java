...
public class DataUsage2Activity extends BaseFragment {
    ...
    class Cell extends FrameLayout {
        ...
        public Cell(Context context) {
            ...
            LinearLayout linearLayout2;
            View view2;
            LinearLayout.LayoutParams layoutParamsCreateLinear2;
            super(context);
            setBackgroundColor(DataUsage2Activity.this.getThemedColor(Theme.key_windowBackgroundWhite));
            ImageView imageView = new ImageView(context);
            this.imageView = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            addView(this.imageView, LayoutHelper.createFrame(28, 28.0f, (LocaleController.isRTL ? 5 : 3) | 16, 18.0f, BitmapDescriptorFactory.HUE_RED, 18.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            if (LocaleController.isRTL) {
                ...
                view = this.textView;
                layoutParamsCreateLinear = LayoutHelper.createLinear(-2, -2, 21);
            } else {
                this.linearLayout2.addView(this.textView, LayoutHelper.createLinear(-2, -2, 16));
                linearLayout = this.linearLayout2;
                view = this.arrowView;
                layoutParamsCreateLinear = LayoutHelper.createLinear(16, 16, 16, 3, 0, 0, 0);
            }
            linearLayout.addView(view, layoutParamsCreateLinear);
            ...
            if (LocaleController.isRTL) {
                ...
                layoutParamsCreateLinear2 = LayoutHelper.createLinear(0, -2, 2.0f, 21);
            } else {
                this.linearLayout.addView(this.linearLayout2, LayoutHelper.createLinear(0, -2, 2.0f, 16));
                linearLayout2 = this.linearLayout;
                view2 = this.valueTextView;
                layoutParamsCreateLinear2 = LayoutHelper.createLinear(-2, -2, 21);
            }
            linearLayout2.addView(view2, layoutParamsCreateLinear2);
        }
    ...
    public class CustomCharacterSpan extends MetricAffectingSpan {
        ...
        public void updateDrawState(TextPaint textPaint) {
            ...
            double dAscent = textPaint.ascent();
            double d = this.ratio;
            Double.isNaN(dAscent);
            textPaint.baselineShift = i + ((int) (dAscent * d));
        }
        ...
        private void updateRows(boolean z) {
            ...
            while (true) {
                ...
                if (j > 0 || z2) {
                    ...
                    if (j == 0) {
                        charSequenceConcat2 = LocaleController.getString(DataUsage2Activity.titles[i4]);
                        i2 = 1;
                    } else {
                        i2 = 1;
                        charSequenceConcat2 = TextUtils.concat(LocaleController.getString(DataUsage2Activity.titles[i4]), "  ", spannableString);
                    }
                    arrayList.add(ItemInner.asCell(i3, i5, themedColor, charSequenceConcat2, AndroidUtilities.formatFileSize(j)));
                } else {
                    str = string;
                    i2 = 1;
                }
                    ...
                    if (i8 < 0 || this.collapsed[i8]) {
                        ...
                        if (DataUsage2Activity.stats[size2.index] == 0) {
                            ...
                            if (size2.inSize > 0 || size2.inCount > 0) {
                                i7++;
                                charSequenceConcat = LocaleController.formatPluralStringComma("IncomingCallsCount", size2.inCount);
                                arrayList.add(i7, ItemInner.asCell(-1, 0, 0, charSequenceConcat, AndroidUtilities.formatFileSize(size2.inSize)));
                            }
                            i = 1;
                        } else {
                            if (DataUsage2Activity.stats[size2.index] != 1) {
                                ...
                                if (size2.inSize > 0 || size2.inCount > 0) {
                                    i7++;
                                    charSequenceConcat = TextUtils.concat(spannableString3, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesReceivedCount", size2.inCount)));
                                    arrayList.add(i7, ItemInner.asCell(-1, 0, 0, charSequenceConcat, AndroidUtilities.formatFileSize(size2.inSize)));
                                }
                            } else {
                                if (size2.outSize > 0 || size2.outCount > 0) {
    ...
    public static class RoundingCell extends View {
        ...
        public RoundingCell(Context context) {
            ...
            this.paint = paint;
            this.top = true;
            paint.setShadowLayer(AndroidUtilities.dp(1.0f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(-0.66f), 251658240);
        ...
        public void setTop(boolean z) {
            ...
            if (z) {
                ...
                rectF = AndroidUtilities.rectTmp;
                fDp2 = ((-getMeasuredHeight()) * 2) - AndroidUtilities.dp(4.0f);
                measuredWidth = getMeasuredWidth();
                measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(4.0f);
            }
            rectF.set(BitmapDescriptorFactory.HUE_RED, fDp2, measuredWidth, measuredHeight);
    ...
    class SubtitleCell extends FrameLayout {
        ...
        public SubtitleCell(Context context) {
            ...
            addView(this.textView, LayoutHelper.createFrame(-1, -2.0f, R.styleable.AppCompatTheme_windowActionModeOverlay, 24.0f, BitmapDescriptorFactory.HUE_RED, 24.0f, 14.0f));
        }
    ...
    public View createView(Context context) {
        ...
        frameLayout.addView(this.pager, LayoutHelper.createFrame(-1, -1.0f, R.styleable.AppCompatTheme_windowActionModeOverlay, BitmapDescriptorFactory.HUE_RED, 48.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
