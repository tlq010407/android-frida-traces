...
public class GLIconSettingsView extends LinearLayout {
    ...
    public GLIconSettingsView(final Context context, final GLIconRenderer gLIconRenderer) {
        ...
        addView(textView, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        seekBarView.setProgress(icon3D == null ? BitmapDescriptorFactory.HUE_RED : icon3D.spec1 / 2.0f);
        seekBarView.setReportChanges(true);
        addView(seekBarView, LayoutHelper.createFrame(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView2, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        Icon3D icon3D2 = gLIconRenderer.model;
        seekBarView2.setProgress(icon3D2 == null ? BitmapDescriptorFactory.HUE_RED : icon3D2.spec2 / 2.0f);
        seekBarView2.setReportChanges(true);
        addView(seekBarView2, LayoutHelper.createFrame(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView3, LayoutHelper.createFrame(-1, 48.0f, 16, 16.0f, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView4, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        Icon3D icon3D3 = gLIconRenderer.model;
        seekBarView3.setProgress(icon3D3 == null ? BitmapDescriptorFactory.HUE_RED : icon3D3.diffuse);
        seekBarView3.setReportChanges(true);
        addView(seekBarView3, LayoutHelper.createFrame(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView5, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        Icon3D icon3D4 = gLIconRenderer.model;
        seekBarView4.setProgress(icon3D4 != null ? icon3D4.normalSpec / 2.0f : f);
        seekBarView4.setReportChanges(true);
        addView(seekBarView4, LayoutHelper.createFrame(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView6, LayoutHelper.createFrame(-1, 48.0f, 16, 16.0f, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView7, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        seekBarView5.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.GLIconSettingsView.7
            ...
            @Override // org.telegram.ui.Components.SeekBarView.SeekBarViewDelegate
            public void onSeekBarDrag(boolean z, float f2) {
                GLIconSettingsView.smallStarsSize = f2 * 2.0f;
            }
        ...
        addView(seekBarView5, LayoutHelper.createFrame(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
    }
}
