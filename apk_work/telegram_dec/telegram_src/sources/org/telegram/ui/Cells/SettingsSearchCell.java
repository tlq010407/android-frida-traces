...
public class SettingsSearchCell extends FrameLayout {
    ...
    public SettingsSearchCell(Context context) {
        ...
        addView(textView2, LayoutHelper.createFrame(-2, -2.0f, z ? 5 : 3, z ? 16.0f : 71.0f, 10.0f, z ? 71.0f : 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView4, LayoutHelper.createFrame(-2, -2.0f, z2 ? 5 : 3, z2 ? 16.0f : 71.0f, 33.0f, z2 ? 71.0f : 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.imageView, LayoutHelper.createFrame(48, 48.0f, LocaleController.isRTL ? 5 : 3, 10.0f, 8.0f, 10.0f, BitmapDescriptorFactory.HUE_RED));
    }

    @Override // android.view.View
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.dp(this.left), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(this.left) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setTextAndValue(CharSequence charSequence, String[] strArr, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    ...
                    spannableStringBuilder.setSpan(new VerticalImageSpan(drawableMutate2), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
        ...
        int iDp22 = AndroidUtilities.dp(16.0f);
        layoutParams22.rightMargin = iDp22;
        layoutParams22.leftMargin = iDp22;
        this.imageView.setVisibility(8);
        this.needDivider = z2;
        setWillNotDraw(!z2);
        this.left = 16;
