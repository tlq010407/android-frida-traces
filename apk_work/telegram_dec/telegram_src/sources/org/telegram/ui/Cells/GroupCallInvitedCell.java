...
public abstract class GroupCallInvitedCell extends FrameLayout {
    ...
    public GroupCallInvitedCell(Context context) {
        ...
        addView(backupImageView2, LayoutHelper.createFrame(46, 46.0f, (z ? 5 : 3) | 48, z ? BitmapDescriptorFactory.HUE_RED : 11.0f, 6.0f, z ? 11.0f : BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(simpleTextView2, LayoutHelper.createFrame(-1, 20.0f, (z2 ? 5 : 3) | 48, z2 ? 54.0f : 67.0f, 10.0f, z2 ? 67.0f : 54.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(simpleTextView4, LayoutHelper.createFrame(-1, 20.0f, (z3 ? 5 : 3) | 48, z3 ? 54.0f : 67.0f, 32.0f, z3 ? 67.0f : 54.0f, BitmapDescriptorFactory.HUE_RED));
    ...
    public void setData(int i, Long l, boolean z, boolean z2, boolean z3) {
        ...
        this.muteButton.setAlpha((z2 || z3) ? BitmapDescriptorFactory.HUE_RED : 1.0f);
    }
