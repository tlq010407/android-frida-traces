...
public class StickerSetNameCell extends FrameLayout {
    ...
    public StickerSetNameCell(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            layoutParamsCreateFrame = LayoutHelper.createFrameRelatively(-2.0f, -2.0f, 8388659, z ? 5.0f : 15.0f, 5.0f, z ? 15.0f : 25.0f, BitmapDescriptorFactory.HUE_RED);
        } else {
            layoutParamsCreateFrame = LayoutHelper.createFrame(-2, -2.0f, 51, z ? 5.0f : 15.0f, 5.0f, z ? 15.0f : 25.0f, BitmapDescriptorFactory.HUE_RED);
        }
        ...
        linearLayout.addView(this.editView, LayoutHelper.createLinear(-2, -2, BitmapDescriptorFactory.HUE_RED, 16, 5, 1, 0, 0));
        ...
        addView(this.urlTextView, z2 ? LayoutHelper.createFrameRelatively(-2.0f, -2.0f, 8388661, 12.0f, 6.0f, 17.0f, BitmapDescriptorFactory.HUE_RED) : LayoutHelper.createFrame(-2, -2.0f, 53, 12.0f, 6.0f, 17.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        if (z2) {
            layoutParamsCreateFrame2 = LayoutHelper.createFrameRelatively(24.0f, 24.0f, 8388661, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, z3 ? BitmapDescriptorFactory.HUE_RED : 10.0f, BitmapDescriptorFactory.HUE_RED);
        } else {
            layoutParamsCreateFrame2 = LayoutHelper.createFrame(24, 24.0f, 53, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, z3 ? BitmapDescriptorFactory.HUE_RED : 10.0f, BitmapDescriptorFactory.HUE_RED);
        }
        this.buttonView.setTranslationY(AndroidUtilities.dp(4.0f));
        addView(this.buttonView, layoutParamsCreateFrame2);
    }
