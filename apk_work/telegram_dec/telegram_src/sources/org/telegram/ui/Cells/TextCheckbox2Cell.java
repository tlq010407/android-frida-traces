...
public class TextCheckbox2Cell extends FrameLayout {
    ...
    public TextCheckbox2Cell(Context context, int i, boolean z) {
        ...
        addView(this.checkbox, LayoutHelper.createFrame(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 16, 22.0f, BitmapDescriptorFactory.HUE_RED, 22.0f, BitmapDescriptorFactory.HUE_RED));
