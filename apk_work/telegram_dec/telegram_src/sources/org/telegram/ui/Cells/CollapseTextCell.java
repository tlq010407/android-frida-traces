...
public class CollapseTextCell extends FrameLayout {
    ...
    public CollapseTextCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(animatedTextView, LayoutHelper.createFrameRelatively(-2.0f, -2.0f, 8388627, 21.0f, BitmapDescriptorFactory.HUE_RED, 38.0f, 3.0f));
        ...
        addView(this.collapsedArrow, LayoutHelper.createFrameRelatively(14.0f, 14.0f, 8388627, 21.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, 3.0f));
    }
