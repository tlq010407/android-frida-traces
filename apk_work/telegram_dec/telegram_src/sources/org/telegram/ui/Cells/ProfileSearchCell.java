    ...
    */
    public void buildLayout() {
        ...
        if (this.encryptedChat != null) {
            ...
            if (LocaleController.isRTL) {
                ...
                iDp2 = AndroidUtilities.dp(AndroidUtilities.leftBaseline + 4) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
            }
            this.nameLeft = iDp2;
        ...
        if (this.ad != null) {
            if (this.adText == null) {
                ...
                coloredImageSpan.translate(-AndroidUtilities.dp(2.0f), BitmapDescriptorFactory.HUE_RED);
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    charSequenceRemoveRTL = AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(userName));
                }
            } else if (charSequence2 == null) {
        ...
        int iDp3 = measuredWidth - AndroidUtilities.dp(f);
        this.nameWidth = iDp3;
        ...
        if (this.contact != null) {
            ...
            int iMeasureText = (int) (textPaint6.measureText(LocaleController.getString(i9)) + 1.0f);
            this.actionLayout = new StaticLayout(LocaleController.getString(i9), Theme.dialogs_countTextPaint, iMeasureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            if (LocaleController.isRTL) {
        ...
        int paddingLeft = iDp3 - (getPaddingLeft() + getPaddingRight());
        if (!this.drawCount || (dialogUnreadCount = MessagesController.getInstance(this.currentAccount).getDialogUnreadCount((TLRPC.Dialog) MessagesController.getInstance(this.currentAccount).dialogs_dict.get(this.dialog_id))) == 0) {
            ...
            String str2 = String.format(Locale.US, "%d", Integer.valueOf(dialogUnreadCount));
            this.countWidth = Math.max(AndroidUtilities.dp(12.0f), (int) Math.ceil(Theme.dialogs_countTextPaint.measureText(str2)));
            this.countLayout = new StaticLayout(str2, Theme.dialogs_countTextPaint, this.countWidth, Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
            int iDp4 = this.countWidth + AndroidUtilities.dp(18.0f);
            this.nameWidth -= iDp4;
            paddingLeft -= iDp4;
            if (LocaleController.isRTL) {
                this.countLeft = AndroidUtilities.dp(19.0f);
                this.nameLeft += iDp4;
                this.statusLeft += iDp4;
            } else {
        ...
        CharSequence charSequenceEllipsize = TextUtils.ellipsize(charSequenceReplaceNewLines, textPaint5, fDp, truncateAt);
        if (charSequenceEllipsize != null) {
            charSequenceEllipsize = Emoji.replaceEmoji(charSequenceEllipsize, textPaint5.getFontMetricsInt(), false);
        }
        int i10 = this.nameWidth;
        Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
        this.nameLayout = new StaticLayout(charSequenceEllipsize, textPaint5, i10, alignment, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        if (chat5 == null || this.subLabel != null) {
                ...
                if (user4 != null) {
                    if (MessagesController.isSupportUser(user4)) {
                        ...
                        if (z && (i2 = user5.bot_active_users) != 0) {
                            userStatus = LocaleController.formatPluralStringSpaced("BotUsersShort", i2);
                        } else if (z) {
                            i = R.string.Bot;
                        } else {
                            long j = user5.id;
        ...
        } else if (ChatObject.isChannel(chat5)) {
            ...
            if (chat6.megagroup) {
                ...
                if (i4 != 0) {
                    str = "Members";
                    userStatus = LocaleController.formatPluralStringComma(str, i4);
                } else {
                    if (chat7.has_geo) {
                        ...
                        userStatus = LocaleController.getString(i5).toLowerCase();
                    }
                    userStatus = LocaleController.getString(i6);
                }
            } else {
        ...
        if (TextUtils.isEmpty(userStatus)) {
            ...
            this.statusLayout = new StaticLayout(TextUtils.ellipsize(userStatus, textPaint7, paddingLeft - AndroidUtilities.dp(12.0f), truncateAt), textPaint7, paddingLeft, alignment, 1.0f, BitmapDescriptorFactory.HUE_RED, false);
        ...
        if (LocaleController.isRTL) {
            ...
            iDp = AndroidUtilities.dp(this.rectangularAvatar ? 15.0f : 11.0f) + getPaddingLeft();
        }
        this.avatarStoryParams.originalAvatarRect.set(iDp, AndroidUtilities.dp(7.0f), iDp + AndroidUtilities.dp(this.rectangularAvatar ? 42.0f : 46.0f), AndroidUtilities.dp(7.0f) + AndroidUtilities.dp(46.0f));
        if (LocaleController.isRTL) {
            ...
            if (this.nameLayout.getLineCount() > 0 && this.nameLayout.getLineRight(0) == this.nameWidth) {
                ...
                if (dCeil3 < d6) {
                    ...
                    Double.isNaN(d6);
                    Double.isNaN(d7);
                    this.nameLeft = (int) (d7 - (d6 - dCeil3));
                }
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.useSeparator) {
            ...
            canvas.drawLine(fDp, measuredHeight, measuredWidth, measuredHeight2, paint2);
        }
        if (this.drawNameLock) {
        ...
        if (staticLayout != null) {
            if (LocaleController.isRTL) {
                iDp = (int) (this.nameLeft + staticLayout.getLineRight(0) + AndroidUtilities.dp(6.0f));
            } else if (staticLayout.getLineLeft(0) == BitmapDescriptorFactory.HUE_RED) {
                iDp = (this.nameLeft - AndroidUtilities.dp(3.0f)) - this.botVerificationDrawable.getIntrinsicWidth();
            } else {
                ...
                Double.isNaN(d);
                double d2 = d - dCeil;
                double dDp = AndroidUtilities.dp(3.0f);
                Double.isNaN(dDp);
                double d3 = d2 - dDp;
                double intrinsicWidth = this.botVerificationDrawable.getIntrinsicWidth();
                Double.isNaN(intrinsicWidth);
                iDp = (int) (d3 - intrinsicWidth);
            }
            BaseCell.setDrawableBounds(this.botVerificationDrawable, iDp, this.nameTop + ((this.nameLayout.getHeight() - this.botVerificationDrawable.getIntrinsicHeight()) / 2.0f));
            ...
            if (!LocaleController.isRTL) {
            ...
            } else if (this.nameLayout.getLineLeft(0) == BitmapDescriptorFactory.HUE_RED) {
                ...
                double dCeil2 = Math.ceil(lineWidth2);
                Double.isNaN(d4);
                double dDp2 = AndroidUtilities.dp(3.0f);
                Double.isNaN(dDp2);
                double d5 = (d4 - dCeil2) - dDp2;
        ...
        if (this.ad != null && this.adText != null && this.adBackgroundPaint != null) {
            ...
            int iDp3 = LocaleController.isRTL ? AndroidUtilities.dp(12.0f) : (getWidth() - AndroidUtilities.dp(12.0f)) - width;
            float f = iDp3;
            this.adBounds.set(f, this.nameTop, iDp3 + width, r13 + iDp2);
            ...
            float f2 = iDp2;
            rectF.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, width, f2);
            float f3 = f2 / 2.0f;
        ...
        float fDp2 = AndroidUtilities.dp(28.0f) + this.openButtonText.getCurrentWidth();
        float fDp3 = LocaleController.isRTL ? AndroidUtilities.dp(15.0f) : (getWidth() - fDp2) - AndroidUtilities.dp(15.0f);
        float fDp4 = AndroidUtilities.dp(28.0f);
        this.openButtonBackgroundPaint.setColor(Theme.getColor(Theme.key_featuredStickers_addButton));
        this.openButtonRect.set(fDp3, (getHeight() - fDp4) / 2.0f, fDp2 + fDp3, (getHeight() + fDp4) / 2.0f);
        canvas.save();
        ...
        this.openButtonText.draw(canvas, fDp3 + AndroidUtilities.dp(14.0f), getHeight() / 2.0f, -1, 1.0f);
        canvas.restore();
    }
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.openBot && this.onOpenButtonClick != null && this.user != null) {
            ...
            return this.user != null ? true : true;
            canvasButton = this.actionButton;
    ...
    public void setData(Object obj, TLRPC.EncryptedChat encryptedChat, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2) {
        ...
        TL_account$RequirementToContact tL_account$RequirementToContactIsUserContactBlocked = null;
        if (obj instanceof TLRPC.User) {
            ...
            if (this.showPremiumBlocked && user != null) {
                tL_account$RequirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.id);
            }
            ...
            if (obj instanceof TLRPC.Chat) {
                ...
                if (obj instanceof ContactsController.Contact) {
                    ...
                    if (this.showPremiumBlocked && contact != null && contact.user != null) {
                        tL_account$RequirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.contact.user.id);
                    }
                    this.premiumBlocked = DialogObject.isPremiumBlocked(tL_account$RequirementToContactIsUserContactBlocked);
                    messagesStarsPrice = DialogObject.getMessagesStarsPrice(tL_account$RequirementToContactIsUserContactBlocked);
                }
    ...
    /* JADX WARN: Removed duplicated region for block: B:15:0x003a A[PHI: r3
      0x003a: PHI (r3v5 org.telegram.tgnet.TLRPC$FileLocation) = (r3v0 org.telegram.tgnet.TLRPC$FileLocation), (r3v7 org.telegram.tgnet.TLRPC$FileLocation) binds: [B:11:0x0030, B:13:0x0036] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:24:0x0064 A[PHI: r3
      0x0064: PHI (r3v1 org.telegram.tgnet.TLRPC$FileLocation) = (r3v0 org.telegram.tgnet.TLRPC$FileLocation), (r3v3 org.telegram.tgnet.TLRPC$FileLocation) binds: [B:20:0x005a, B:22:0x0060] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void update(int i) {
        ...
        if (user3 != null) {
            ...
            if (UserObject.isReplyUser(this.user)) {
                ...
                if (userProfilePhoto != null) {
                    ...
                    Drawable drawable2 = userProfilePhoto.strippedBitmap;
                    Drawable drawable3 = drawable2 != null ? drawable2 : drawable;
                    this.avatarImage.setImage(ImageLocation.getForUserOrChat(user4, 1), "50_50", ImageLocation.getForUserOrChat(this.user, 2), "50_50", drawable3, this.user, 0);
                }
            }
            ...
            if (chat != null) {
                ...
                if (chatPhoto != null) {
                    ...
                    Drawable drawable5 = drawable4 != null ? drawable4 : avatarDrawable;
                    if (chat.monoforum) {
                        ...
                        this.avatarImage.setImage(ImageLocation.getForUserOrChat(this.chat, 1), "50_50", ImageLocation.getForUserOrChat(this.chat, 2), "50_50", drawable5, this.chat, 0);
                    }
                }
            } else {
                ContactsController.Contact contact = this.contact;
        ...
        if (chat2 == null || !chat2.monoforum) {
            iDp = AndroidUtilities.dp(this.rectangularAvatar ? 10.0f : (chat2 == null || !chat2.forum) ? 23.0f : 16.0f);
        } else {
            iDp = 0;
        }
