...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.addView(this.countTextView, LayoutHelper.createLinear(-2, -1, 4.0f, BitmapDescriptorFactory.HUE_RED, 7.0f, 5.0f));
    ...
    protected void onMeasure(int i, int i2) {
        int iDp = (((AndroidUtilities.isTablet() ? AndroidUtilities.dp(490.0f) : AndroidUtilities.displaySize.x) - AndroidUtilities.dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.dp(4.0f))) / this.albumsCount;
