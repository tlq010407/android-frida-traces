...
public class TextDetailSettingsCell extends FrameLayout {
    ...
    public TextDetailSettingsCell(Context context) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 21.0f, 10.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.valueTextView, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 21.0f, 35.0f, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.imageView, LayoutHelper.createFrame(52, 52.0f, (LocaleController.isRTL ? 5 : 3) | 48, 8.0f, 6.0f, 8.0f, BitmapDescriptorFactory.HUE_RED));
    }
