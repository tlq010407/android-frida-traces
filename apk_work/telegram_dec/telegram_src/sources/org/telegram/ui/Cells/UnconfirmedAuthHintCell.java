...
public class UnconfirmedAuthHintCell extends BlurredFrameLayout {
    ...
    private static class TextViewWithLoading extends TextView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f < 1.0f) {
                ...
                canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(-12.0f) * f);
                super.onDraw(canvas);
                canvas.restore();
            }
    ...
    public void set(final BaseFragment baseFragment, final int i) {
        ...
        if (arrayList == null || arrayList.size() != 1) {
            if (arrayList != null && arrayList.size() > 1) {
                ...
                if (str == null) {
                    ...
                    pluralString = LocaleController.formatPluralString("UnconfirmedAuthMultipleFrom", arrayList.size(), str);
                }
            }
        ...
        textView = this.messageTextView;
        pluralString = LocaleController.formatString(R.string.UnconfirmedAuthSingle, str3);
    ...
    public void showLoginPreventedSheet(ArrayList arrayList) {
        ...
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2, 28.0f, 14.0f, 28.0f, BitmapDescriptorFactory.HUE_RED));
        TextView textView2 = new TextView(getContext());
        textView2.setTextSize(1, 14.0f);
        textView2.setGravity(17);
        if (arrayList.size() == 1) {
            string = LocaleController.formatString(R.string.UnconfirmedAuthDeniedMessageSingle, from((UnconfirmedAuthController.UnconfirmedAuth) arrayList.get(0)));
        } else {
            String str = "\n";
            for (int i = 0; i < Math.min(arrayList.size(), 10); i++) {
                str = str + "• " + from((UnconfirmedAuthController.UnconfirmedAuth) arrayList.get(i)) + "\n";
            }
            string = LocaleController.formatString(R.string.UnconfirmedAuthDeniedMessageMultiple, str);
        }
        textView2.setText(string);
        textView2.setTextColor(Theme.getColor(Theme.key_dialogTextBlack));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2, 40.0f, 9.0f, 40.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        frameLayout.addView(textView3, LayoutHelper.createFrame(-1, -1, R.styleable.AppCompatTheme_windowActionModeOverlay));
        linearLayout.addView(frameLayout, LayoutHelper.createLinear(-1, -2, 14.0f, 19.0f, 14.0f, BitmapDescriptorFactory.HUE_RED));
