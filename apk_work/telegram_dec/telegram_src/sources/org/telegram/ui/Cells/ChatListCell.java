...
public abstract class ChatListCell extends LinearLayout {
    ...
    private class ListView extends FrameLayout {
        ...
        public ListView(Context context, boolean z) {
            ...
            addView(this.button, LayoutHelper.createFrame(22, 22.0f, 53, BitmapDescriptorFactory.HUE_RED, 26.0f, 10.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), AndroidUtilities.dp(74.0f));
                ...
                while (true) {
                    if (i3 < (this.isThreeLines ? 3 : 2)) {
                        ...
                        if (this.isThreeLines) {
                            ...
                            rectF = this.rect;
                            fDp = AndroidUtilities.dpf2(1.5f);
                            fDp2 = AndroidUtilities.dpf2(1.5f);
                        } else {
                            int i4 = i3 * 10;
                        ...
                        canvas.drawRoundRect(rectF, fDp, fDp2, Theme.dialogs_onlineCirclePaint);
                        i3++;
                    }
                }
                i++;
