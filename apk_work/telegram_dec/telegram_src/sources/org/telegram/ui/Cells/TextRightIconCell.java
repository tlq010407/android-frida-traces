...
public class TextRightIconCell extends FrameLayout {
    ...
    public TextRightIconCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(simpleTextView, LayoutHelper.createFrame(-1, 48.0f, 16, 22.0f, BitmapDescriptorFactory.HUE_RED, 56.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(imageView, LayoutHelper.createFrame(24, 24.0f, 8388629, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
