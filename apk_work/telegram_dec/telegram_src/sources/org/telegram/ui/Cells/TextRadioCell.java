...
public class TextRadioCell extends FrameLayout {
    ...
    public TextRadioCell(Context context, int i, boolean z) {
        ...
        addView(textView3, LayoutHelper.createFrame(-1, -1.0f, (z2 ? 5 : 3) | 48, z2 ? i : 64.0f, BitmapDescriptorFactory.HUE_RED, z2 ? 64.0f : i, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView5, LayoutHelper.createFrame(-2, -2.0f, (z3 ? 5 : 3) | 48, z3 ? i : 64.0f, 36.0f, z3 ? 64.0f : i, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.radioButton, LayoutHelper.createFrame(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 16, 22.0f, BitmapDescriptorFactory.HUE_RED, 22.0f, BitmapDescriptorFactory.HUE_RED));
