...
public class DialogRadioCell extends FrameLayout {
    ...
    public DialogRadioCell(Context context, boolean z) {
        ...
        addView(textView3, LayoutHelper.createFrame(-1, -1.0f, (z2 ? 5 : 3) | 48, z2 ? 23.0f : 61.0f, BitmapDescriptorFactory.HUE_RED, z2 ? 61.0f : 23.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.valueTextView, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 23.0f, BitmapDescriptorFactory.HUE_RED, 23.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.radioButton, LayoutHelper.createFrame(22, 22.0f, (LocaleController.isRTL ? 5 : 3) | 48, 20.0f, 15.0f, 20.0f, BitmapDescriptorFactory.HUE_RED));
    }
