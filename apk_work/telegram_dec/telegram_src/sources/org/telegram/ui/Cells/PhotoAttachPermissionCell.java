...
public class PhotoAttachPermissionCell extends FrameLayout {
    ...
    public PhotoAttachPermissionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(this.imageView, LayoutHelper.createFrame(44, 44.0f, 17, 5.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 27.0f));
        ...
        addView(this.imageView2, LayoutHelper.createFrame(44, 44.0f, 17, 5.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 27.0f));
        TextView textView = new TextView(context);
        this.textView = textView;
        textView.setTextColor(getThemedColor(Theme.key_chat_attachPermissionText));
        this.textView.setTextSize(1, 12.0f);
        this.textView.setGravity(17);
        addView(this.textView, LayoutHelper.createFrame(-2, -2.0f, 17, 5.0f, 13.0f, 5.0f, BitmapDescriptorFactory.HUE_RED));
    ...
    public void setType(int i) {
        ...
        imageView.setLayoutParams(LayoutHelper.createFrame(i2, f3, i3, f4, BitmapDescriptorFactory.HUE_RED, f, f2));
        this.imageView2.setLayoutParams(LayoutHelper.createFrame(44, f3, i3, f4, BitmapDescriptorFactory.HUE_RED, f, f2));
    }
}
