...
public class TextCheckCell extends FrameLayout {
    ...
    public TextCheckCell(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(textView3, LayoutHelper.createFrame(-1, -1.0f, (z2 ? 5 : 3) | 48, z2 ? 70.0f : i, BitmapDescriptorFactory.HUE_RED, z2 ? i : 70.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView5, LayoutHelper.createFrame(-2, -2.0f, (z3 ? 5 : 3) | 48, z3 ? 70.0f : i, 35.0f, z3 ? i : 70.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.checkBox, LayoutHelper.createFrame(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, BitmapDescriptorFactory.HUE_RED, 22.0f, BitmapDescriptorFactory.HUE_RED));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (paint != null) {
                ...
                canvas.drawLine(fDp, f, measuredWidth - iDp, getMeasuredHeight() - 1, paint);
            }
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (z) {
            ...
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.valueTextView.getVisibility() == 0 ? 64.0f : this.height) + (this.needDivider ? 1 : 0), 1073741824);
        }
    ...
    public void setBackgroundColorAnimated(boolean z, final int i) {
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, (Property<TextCheckCell, Float>) ANIMATION_PROGRESS, BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    public void setBackgroundColorAnimatedReverse(final int i) {
        ...
        this.animatedColorBackground = i;
        ObjectAnimator duration = ObjectAnimator.ofFloat(this, (Property<TextCheckCell, Float>) ANIMATION_PROGRESS, 1.0f, BitmapDescriptorFactory.HUE_RED).setDuration(240L);
    ...
    public void setColorfullIcon(int i, int i2) {
        if (this.imageView == null) {
            ...
            addView(this.imageView, LayoutHelper.createFrame(29, 29.0f, (LocaleController.isRTL ? 5 : 3) | 16, 19.0f, BitmapDescriptorFactory.HUE_RED, 19.0f, BitmapDescriptorFactory.HUE_RED));
    ...
    public void updateRTL() {
        ...
        TextView textView = this.textView;
        boolean z3 = LocaleController.isRTL;
        addView(textView, LayoutHelper.createFrame(-1, -1.0f, (z3 ? 5 : 3) | 48, z3 ? 70.0f : this.padding, BitmapDescriptorFactory.HUE_RED, z3 ? this.padding : 70.0f, BitmapDescriptorFactory.HUE_RED));
        this.valueTextView.setGravity(LocaleController.isRTL ? 5 : 3);
        removeView(this.valueTextView);
        TextView textView2 = this.valueTextView;
        boolean z4 = LocaleController.isRTL;
        addView(textView2, LayoutHelper.createFrame(-2, -2.0f, (z4 ? 5 : 3) | 48, z4 ? 64.0f : this.padding, 36.0f, z4 ? this.padding : 64.0f, BitmapDescriptorFactory.HUE_RED));
