...
public class TextSettingsCell extends FrameLayout {
    ...
    public TextSettingsCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        float f = i;
        addView(this.textView, LayoutHelper.createFrame(-1, -1.0f, (LocaleController.isRTL ? 5 : 3) | 48, f, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.valueTextView, LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.imageView, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 21.0f, BitmapDescriptorFactory.HUE_RED, 21.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.valueImageView, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 3 : 5) | 16, f, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED));
    }
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? BitmapDescriptorFactory.HUE_RED : AndroidUtilities.dp(this.imageView.getVisibility() == 0 ? 71.0f : 20.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? r0 : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public BackupImageView getValueBackupImageView() {
        if (this.valueBackupImageView == null) {
            ...
            addView(backupImageView, LayoutHelper.createFrame(24, 24.0f, i, f, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED));
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.valueTextView.getVisibility() == 0) {
            ...
            measuredWidth = this.betterLayout ? measuredWidth2 - (this.valueTextView.getMeasuredWidth() + AndroidUtilities.dp(8.0f)) : (measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f);
            if (this.valueImageView.getVisibility() == 0) {
    ...
    public void setIcon(int i) {
        ...
        if (i == 0) {
            this.imageView.setVisibility(8);
            if (LocaleController.isRTL) {
                iDp2 = AndroidUtilities.dp(this.padding);
                marginLayoutParams.rightMargin = iDp2;
            } else {
                iDp = AndroidUtilities.dp(this.padding);
    ...
    public void updateRTL() {
        ...
        float f = this.padding;
        addView(textView, LayoutHelper.createFrame(-1, -1.0f, i, f, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED));
        this.valueTextView.setGravity((LocaleController.isRTL ? 3 : 5) | 16);
        removeView(this.valueTextView);
        AnimatedTextView animatedTextView = this.valueTextView;
        int i2 = (LocaleController.isRTL ? 3 : 5) | 48;
        float f2 = this.padding;
        addView(animatedTextView, LayoutHelper.createFrame(-2, -1.0f, i2, f2, BitmapDescriptorFactory.HUE_RED, f2, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(imageView, LayoutHelper.createFrame(-2, -2.0f, i3 | 16, f3, BitmapDescriptorFactory.HUE_RED, f3, BitmapDescriptorFactory.HUE_RED));
    }
}
