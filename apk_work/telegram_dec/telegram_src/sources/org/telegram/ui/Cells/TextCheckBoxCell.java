...
public class TextCheckBoxCell extends FrameLayout {
    ...
    public TextCheckBoxCell(Context context, boolean z, boolean z2) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-1, -1.0f, (z3 ? 5 : 3) | 48, z3 ? 66.0f : 21.0f, BitmapDescriptorFactory.HUE_RED, z3 ? 21.0f : 66.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.checkBox, LayoutHelper.createFrame(18, 18.0f, (z3 ? 3 : 5) | 16, 21.0f, BitmapDescriptorFactory.HUE_RED, 21.0f, BitmapDescriptorFactory.HUE_RED));
    }
