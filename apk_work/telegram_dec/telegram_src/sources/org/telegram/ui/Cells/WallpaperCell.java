        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                if (photoSize != null) {
                    ...
                    forDocument2 = ImageLocation.getForDocument(closestPhotoSizeWithSize, r1.document);
                    str = "jpg";
                    i = 1;
                } else {
                ...
                r8.setImage(forDocument, str2, forDocument2, null, str, j, i, r1);
                imageReceiver = this.imageView.getImageReceiver();
                fAbs = Math.abs(r1.settings.intensity) / 100.0f;
                imageReceiver.setAlpha(fAbs);
                return;
            }
            if (obj instanceof WallpapersListActivity.ColorWallpaper) {
                ...
                if ("d".equals(colorWallpaper.slug)) {
                    ...
                    imageReceiver = this.imageView.getImageReceiver();
                    fAbs = Math.abs(colorWallpaper.intensity);
                    imageReceiver.setAlpha(fAbs);
                    return;
                }
