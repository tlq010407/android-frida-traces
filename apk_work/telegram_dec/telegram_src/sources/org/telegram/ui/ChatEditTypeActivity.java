...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        if (this.isChannel) {
            string = LocaleController.formatString("RevokeLinkAlertChannel", R.string.RevokeLinkAlertChannel, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title);
        } else {
            string = LocaleController.formatString("RevokeLinkAlert", R.string.RevokeLinkAlert, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title);
        }
    ...
    private boolean trySetUsername() {
        ...
        if (ChatObject.isChannel(this.currentChat)) {
            getMessagesController().updateChannelUserName(this, this.chatId, string, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void updateDoneProgress(boolean z) {
        ...
        if (this.doneButtonDrawable != null) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda13
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x012b A[PHI: r0
      0x012b: PHI (r0v14 org.telegram.ui.Cells.HeaderCell) = (r0v13 org.telegram.ui.Cells.HeaderCell), (r0v39 org.telegram.ui.Cells.HeaderCell) binds: [B:40:0x0129, B:32:0x010f] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x0132 A[PHI: r0
      0x0132: PHI (r0v37 org.telegram.ui.Cells.HeaderCell) = (r0v13 org.telegram.ui.Cells.HeaderCell), (r0v39 org.telegram.ui.Cells.HeaderCell) binds: [B:40:0x0129, B:32:0x010f] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void updatePrivatePublic() {
        ...
        Drawable themedDrawableByKey = null;
        int i2 = 8;
        if (this.isPrivate || this.canCreatePublic || !getUserConfig().isPremium()) {
            ...
            if (this.isPrivate) {
                ...
                textInfoPrivacyCell4.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell4.getContext(), R.drawable.greydivider, i5));
                this.manageLinksInfoCell.setBackground(Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), i4, i5));
            } else {
                view = this.typeInfoCell;
                if (this.checkTextView.getVisibility() != 0) {
                    themedDrawableByKey = Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), i4, i5);
                }
                view.setBackgroundDrawable(themedDrawableByKey);
            }
        } else {
            ...
            if (this.loadingAdminedChannels) {
                ...
                shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(context2, i7, i8));
                TextInfoPrivacyCell textInfoPrivacyCell6 = this.typeInfoCell;
                textInfoPrivacyCell6.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell6.getContext(), R.drawable.greydivider_top, i8));
                this.loadingAdminedCell.setVisibility(8);
    ...
    public View createView(final Context context) {
        ...
        drawableMutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i6), PorterDuff.Mode.MULTIPLY));
        CrossfadeDrawable crossfadeDrawable = new CrossfadeDrawable(drawableMutate, new CircularProgressDrawable(Theme.getColor(i6)));
        ...
        this.linkContainer.addView(this.publicContainer, LayoutHelper.createLinear(-1, 36, 23.0f, 7.0f, 23.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        this.usernameTextView.addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.ChatEditTypeActivity.4
            ...
            public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
                ...
                String string3 = ChatEditTypeActivity.this.usernameTextView.getText().toString();
                if (ChatEditTypeActivity.this.editableUsernameCell != null) {
                    ChatEditTypeActivity.this.editableUsernameCell.updateUsername(string3);
                }
                ChatEditTypeActivity.this.checkUserName(string3);
            }
        });
