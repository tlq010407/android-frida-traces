...
public abstract class CachedMediaLayout extends FrameLayout implements NestedSizeNotifierLayout.ChildLayout {
    ...
    class AnonymousClass1 extends ViewPagerFixed.Adapter {
        ...
        public /* synthetic */ void lambda$createView$0(ItemInner itemInner, BaseAdapter baseAdapter, RecyclerListView recyclerListView, View view, View view2) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$createView$1(ItemInner itemInner, View view, View view2) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$createView$2(ItemInner itemInner, View view, View view2) throws Resources.NotFoundException {
            CachedMediaLayout.this.openItem(itemInner.file, (CacheCell) view);
            ActionBarPopupWindow actionBarPopupWindow = this.popupWindow;
            if (actionBarPopupWindow != null) {
                actionBarPopupWindow.dismiss();
        ...
        public /* synthetic */ boolean lambda$createView$5(final RecyclerListView recyclerListView, final BaseFragment baseFragment, final View view, int i, float f, float f2) {
            ...
            if (view instanceof SharedPhotoVideoCell2) {
                ...
                if (((CacheCell) view).container.getChildAt(0) instanceof SharedAudioCell) {
                    actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, R.drawable.msg_played, LocaleController.getString(R.string.PlayFile), false, null);
                    ...
                    actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, R.drawable.msg_view_file, LocaleController.getString(R.string.CacheOpenFile), false, null);
    ...
    class CacheCell extends FrameLayout {
        ...
        public CacheCell(Context context) {
            ...
            if (LocaleController.isRTL) {
                ...
                addView(checkBox22, LayoutHelper.createFrame(24, 24.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 18.0f, BitmapDescriptorFactory.HUE_RED));
                addView(view, LayoutHelper.createFrame(40, 40.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                f3 = -2.0f;
                addView(this.container, LayoutHelper.createFrame(-1, -2.0f, 0, 90.0f, BitmapDescriptorFactory.HUE_RED, 40.0f, BitmapDescriptorFactory.HUE_RED));
                ...
                f = BitmapDescriptorFactory.HUE_RED;
                f2 = BitmapDescriptorFactory.HUE_RED;
                addView(checkBox23, LayoutHelper.createFrame(24, 24.0f, 19, 18.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                addView(view, LayoutHelper.createFrame(40, 40.0f, 19, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                f3 = -2.0f;
                addView(this.container, LayoutHelper.createFrame(-1, -2.0f, 0, 48.0f, BitmapDescriptorFactory.HUE_RED, 90.0f, BitmapDescriptorFactory.HUE_RED));
                textView = this.sizeTextView;
                f4 = 21.0f;
                i = 69;
                i2 = 21;
            }
            addView(textView, LayoutHelper.createFrame(i, f3, i2, BitmapDescriptorFactory.HUE_RED, f2, f4, f));
        }
    ...
    public CachedMediaLayout(Context context, BaseFragment baseFragment) {
        ...
        while (true) {
            ...
            if (i >= pageArr2.length) {
                ...
                addView(this.viewPagerFixed, LayoutHelper.createFrame(-1, -1.0f, 0, BitmapDescriptorFactory.HUE_RED, 48.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                ...
                addView(view, LayoutHelper.createFrame(-1, 1.0f, 0, BitmapDescriptorFactory.HUE_RED, 48.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
