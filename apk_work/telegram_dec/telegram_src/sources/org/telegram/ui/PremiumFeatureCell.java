...
public class PremiumFeatureCell extends FrameLayout {
    ...
    public PremiumFeatureCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(this.imageView, LayoutHelper.createFrame(28, 28.0f, 0, 18.0f, 12.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(imageView2, LayoutHelper.createFrame(24, 24.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 18.0f, BitmapDescriptorFactory.HUE_RED));
    }
