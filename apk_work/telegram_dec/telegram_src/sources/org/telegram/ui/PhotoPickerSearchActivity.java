...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    public View createView(Context context) {
                        ...
                        if (i13 == 1) {
                            ...
                            if (i12 == 16) {
                                if (i12 == 48) {
                                    ...
                                    i9 = ((i7 - emojiPadding) - i5) - measuredHeight2;
                                }
                                ...
                                i9 = ((((i7 - emojiPadding) - i5) - measuredHeight2) / 2) + layoutParams.topMargin;
                            }
                    ...
                    if (this.startedTracking) {
                        ...
                        if (PhotoPickerSearchActivity.this.backAnimation) {
                            ...
                            if (PhotoPickerSearchActivity.this.animatingForward) {
                                ...
                                animatorSet.playTogether(ObjectAnimator.ofFloat(viewPage2, (Property<ViewPage, Float>) property, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], (Property<ViewPage, Float>) property, PhotoPickerSearchActivity.this.viewPages[1].getMeasuredWidth()));
                            } else {
                                ...
                                animatorSet2.playTogether(ObjectAnimator.ofFloat(viewPage3, (Property<ViewPage, Float>) property2, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], (Property<ViewPage, Float>) property2, -PhotoPickerSearchActivity.this.viewPages[1].getMeasuredWidth()));
                            }
                        } else {
                            ...
                            if (PhotoPickerSearchActivity.this.animatingForward) {
                                ...
                                animatorSet3.playTogether(ObjectAnimator.ofFloat(viewPage4, (Property<ViewPage, Float>) property3, -PhotoPickerSearchActivity.this.viewPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], (Property<ViewPage, Float>) property3, BitmapDescriptorFactory.HUE_RED));
                            } else {
                                ...
                                animatorSet4.playTogether(ObjectAnimator.ofFloat(viewPage5, (Property<ViewPage, Float>) property4, PhotoPickerSearchActivity.this.viewPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(PhotoPickerSearchActivity.this.viewPages[1], (Property<ViewPage, Float>) property4, BitmapDescriptorFactory.HUE_RED));
                            }
                        }
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(Math.abs(xVelocity) > BitmapDescriptorFactory.HUE_RED ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / r4) * 1000.0f) * 4 : (int) (((measuredWidth / getMeasuredWidth()) + 1.0f) * 100.0f), 600)));
        ...
        sizeNotifierFrameLayout.addView(this.imagesSearch.writeButtonContainer, LayoutHelper.createFrame(60, 60.0f, 85, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 12.0f, 10.0f));
        sizeNotifierFrameLayout.addView(this.imagesSearch.selectedCountView, LayoutHelper.createFrame(42, 24.0f, 85, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, -2.0f, 9.0f));
        updateTabs();
