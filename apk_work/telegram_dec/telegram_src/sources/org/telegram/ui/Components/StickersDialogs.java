...
public abstract class StickersDialogs {
    ...
    public static /* synthetic */ void lambda$showNameEditorDialog$2(final EditTextBoldCursor editTextBoldCursor, Utilities.Callback2 callback2, Context context, boolean z, final AlertDialog alertDialog, int i) {
        ...
        callback2.run(strTrim, new Utilities.Callback() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda6
    ...
    public static void showNameEditorDialog(TLRPC.StickerSet stickerSet, Theme.ResourcesProvider resourcesProvider, final Context context, final Utilities.Callback2 callback2) {
        ...
        int iDp = AndroidUtilities.dp(z2 ? 28.0f : BitmapDescriptorFactory.HUE_RED);
        if (!LocaleController.isRTL) {
            f = 28.0f;
        }
        editTextBoldCursor.setPadding(iDp, 0, AndroidUtilities.dp(f), 0);
        ...
        frameLayout.addView(numberTextView, LayoutHelper.createFrame(26, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, BitmapDescriptorFactory.HUE_RED, 2.0f, 4.0f, BitmapDescriptorFactory.HUE_RED));
