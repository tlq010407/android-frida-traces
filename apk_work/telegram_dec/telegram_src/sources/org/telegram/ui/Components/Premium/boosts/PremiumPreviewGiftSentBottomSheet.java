...
public class PremiumPreviewGiftSentBottomSheet extends PremiumPreviewBottomSheet {
    ...
    static class AvatarHolderView extends FrameLayout {
        ...
        public AvatarHolderView(Context context, float f) {
            ...
            addView(additionalCounterView, LayoutHelper.createFrame(26, 26.0f, 85, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f, 3.0f));
        ...
        public static View createAvatarsContainer(Context context, List list) {
            ...
            if (list.size() == 1) {
                frameLayout.addView(frameLayout2, LayoutHelper.createFrame(-1, 94.0f, 0, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                ...
                frameLayout.addView(frameLayout2, LayoutHelper.createFrame(-1, 83.0f, 0, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
                int i = 0;
    ...
    private void init() {
        ...
        this.containerView.addView(actionBtnCell, LayoutHelper.createFrame(-1, 64.0f, 80, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
    ...
    protected void attachIconContainer(LinearLayout linearLayout) {
        linearLayout.addView(this.overrideTitleIcon, LayoutHelper.createLinear(-1, this.selectedUsers.size() == 1 ? 94 : 83, BitmapDescriptorFactory.HUE_RED, this.selectedUsers.size() == 1 ? 28.0f : 34.0f, BitmapDescriptorFactory.HUE_RED, this.selectedUsers.size() == 1 ? 9.0f : 14.0f));
    }
    ...
    public void setTitle(boolean z) {
        ...
        if (this.selectedUsers.size() == 1) {
            ...
            string2 = LocaleController.formatString("GiftPremiumGiftsSentStatusForUser", R.string.GiftPremiumGiftsSentStatusForUser, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0)));
        } else {
            textView = this.subtitleView;
            string2 = LocaleController.getString("GiftPremiumGiftsSentStatus", R.string.GiftPremiumGiftsSentStatus);
        }
        textView.append(AndroidUtilities.replaceTags(string2));
    }
