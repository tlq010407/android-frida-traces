...
public class SnowflakesEffect {
        ...
        public void draw(Canvas canvas) {
            ...
            if (snowflakesEffect.particleBitmap == null) {
                ...
                while (i < 6) {
                    ...
                    double d4 = fDpf22;
                    Double.isNaN(d4);
                    float f5 = (float) ((dCos * d3) - (dSin * d4));
                    ...
                    float f6 = fDpf22;
                    float f7 = fDp + f3;
                    float f8 = fDp2 + (fSin * 0.66f);
                    canvas2.drawLine(f7, f8, fDp + f5, fDp2 + ((float) ((dSin2 * d3) + (dCos2 * d4))), SnowflakesEffect.this.particleThinPaint);
                    double d5 = -Math.cos(d2);
                    Double.isNaN(d3);
                    double d6 = d5 * d3;
                    double dSin3 = Math.sin(d2);
                    Double.isNaN(d4);
                    float f9 = (float) (d6 - (dSin3 * d4));
                    double d7 = -Math.sin(d2);
                    Double.isNaN(d3);
                    double d8 = d7 * d3;
                    double dCos3 = Math.cos(d2);
                    Double.isNaN(d4);
                    canvas2.drawLine(f7, f8, fDp + f9, fDp2 + ((float) (d8 + (dCos3 * d4))), SnowflakesEffect.this.particleThinPaint);
                    f2 += 1.0471976f;
                    i++;
                    fDpf2 = f4;
                    f = f;
    ...
    public void onDraw(View view, Canvas canvas) {
        ...
        int i3 = i2 == 0 ? 100 : LocationRequest.PRIORITY_INDOOR;
        int i4 = i2 == 0 ? 1 : 10;
        if (this.particles.size() < i3) {
            for (int i5 = 0; i5 < i4; i5++) {
                if (this.particles.size() < i3 && Utilities.random.nextFloat() > 0.7f) {
                    ...
                    double dNextInt = Utilities.random.nextInt(40) + 70;
