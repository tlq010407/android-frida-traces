...
public class UItem extends AdapterWithDiffUtils.Item {
    ...
    public boolean equals(Object obj) {
        ...
        return (i == 36 || i == 35) ? this.id == uItem.id : i == 31 ? TextUtils.equals(this.text, uItem.text) : (i < factoryViewTypeStartsWith || (uItemFactoryFindFactory = findFactory(i)) == null) ? itemEquals(uItem) : uItemFactoryFindFactory.equals(this, uItem);
    }
