...
public class WallpaperCheckBoxView extends View {
    ...
    private void animateToCheckedState(boolean z) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, (Property<WallpaperCheckBoxView, Float>) this.PROGRESS_PROPERTY, z ? 1.0f : BitmapDescriptorFactory.HUE_RED);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawBitmap != null) {
            ...
            this.rect.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f));
            ...
            if (iArr[3] != 0) {
                ...
                while (i2 < 3) {
                    this.backgroundPaint.setColor(this.colors[i2]);
                    canvas.drawArc(this.rect, (i2 * R.styleable.AppCompatTheme_windowFixedHeightMajor) - 90, 120.0f, true, this.backgroundPaint);
                    i2++;
                }
            } else if (iArr[1] != 0) {
                while (i2 < 2) {
