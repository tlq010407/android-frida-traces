    ...
    public StoryLinkPreviewDialog(Context context, final int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                if (StoryLinkPreviewDialog.this.openProgress > BitmapDescriptorFactory.HUE_RED && StoryLinkPreviewDialog.this.blurBitmapPaint != null) {
                    ...
                    canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight(), StoryLinkPreviewDialog.this.blurBitmapPaint);
                }
        ...
        frameLayout3.addView(textView, LayoutHelper.createFrame(-1, -2.0f, 55, 18.0f, 8.33f, 18.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        frameLayout3.addView(textView2, LayoutHelper.createFrame(-1, -2.0f, 55, 18.0f, 31.0f, 18.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        frameLayout2.addView(frameLayout4, LayoutHelper.createFrame(-1, -1.0f, R.styleable.AppCompatTheme_windowActionModeOverlay, BitmapDescriptorFactory.HUE_RED, 56.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ImageView imageView = new ImageView(context);
        this.backgroundView = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        frameLayout4.addView(imageView, LayoutHelper.createFrame(-1, -1, R.styleable.AppCompatTheme_windowActionModeOverlay));
        ...
        itemOptionsMakeOptions.add(R.drawable.msg_select, LocaleController.getString(R.string.ApplyChanges), new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.dismiss();
            }
        });
        itemOptionsMakeOptions.add(R.drawable.msg_delete, (CharSequence) LocaleController.getString(R.string.DoNotLinkPreview), true, new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$3();
            }
        });
        linearLayout.addView(itemOptionsMakeOptions.getLayout(), LayoutHelper.createLinear(-2, -2, BitmapDescriptorFactory.HUE_RED, 85));
    ...
    private void animateOpenTo(final boolean z, final Runnable runnable) {
        ...
        this.openAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.7
            ...
            public void onAnimationEnd(Animator animator) {
                StoryLinkPreviewDialog.this.openProgress = z ? 1.0f : BitmapDescriptorFactory.HUE_RED;
