...
public class AudioVisualizerDrawable {
        ...
        if (LiteMode.isEnabled(32)) {
            for (int i = 0; i < 8; i++) {
                ...
                if (f3 != f4) {
                    ...
                    fArr2[i] = f5;
                    float f6 = fArr3[i];
                    if ((f6 > BitmapDescriptorFactory.HUE_RED && f5 > fArr[i]) || (f6 < BitmapDescriptorFactory.HUE_RED && f5 < fArr[i])) {
                        fArr2[i] = fArr[i];
                    }
    ...
    public void setWaveform(boolean z, boolean z2, float[] fArr) {
        if (LiteMode.isEnabled(32)) {
            ...
            while (i < 7) {
                ...
                if (this.parentView == null) {
                    ...
                    if (i == 6) {
                        ...
                        fArr5[i] = (fArr6[i] - this.current[i]) / f3;
                    }
                }
                i++;
            }
            ...
            fArr7[7] = f;
            this.dt[7] = (f - this.current[7]) / 120.0f;
        }
    }
}
