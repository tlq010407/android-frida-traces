...
public class SelectorHeaderCell extends FrameLayout {
    ...
    public SelectorHeaderCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(textView, LayoutHelper.createFrame(-1, -2.0f, 23, z ? 16.0f : 53.0f, BitmapDescriptorFactory.HUE_RED, z ? 53.0f : 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(imageView, LayoutHelper.createFrame(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
