...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class SegmentedObject {
        ...
        public AnimatedFloat select = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, (View) null, 0, 320, CubicBezierInterpolator.EASE_OUT_QUINT);
        ...
        public void drawAnimationBorders(Canvas canvas, float f, float f2, View view) {
            ...
            if (StickerMakerView.this.sourceBitmap == null || f2 <= BitmapDescriptorFactory.HUE_RED) {
                return;
            }
            ...
            if (this.points != null) {
                ...
                int i2 = (int) (f * f10);
                int iMin2 = Math.min(500, (int) (f10 * 0.6f)) + i2;
                if (this.pointsCount > 0) {
                    for (int i3 = i2; i3 <= iMin2; i3++) {
                        float f11 = (i3 - i2) / (iMin2 - i2);
                ...
                if (f12 > 1.0f) {
                    this.partSegmentBorderPath.reset();
                    StickerMakerView.this.bordersPathMeasure.setPath(this.segmentBorderPath, false);
                    StickerMakerView.this.bordersPathMeasure.getSegment(BitmapDescriptorFactory.HUE_RED, (f12 - 1.0f) * length, this.partSegmentBorderPath, true);
                    canvas.drawPath(this.partSegmentBorderPath, StickerMakerView.this.segmentBorderPaint);
                    canvas.drawPath(this.partSegmentBorderPath, StickerMakerView.this.segmentBorderPaint);
                }
            }
        ...
        public Bitmap makeDarkMaskImage() {
            ...
            canvas.drawBitmap(getImage(), BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, paint);
    ...
    public static class StickerUploader {
        ...
        private float convertingProgress = BitmapDescriptorFactory.HUE_RED;
        private float uploadProgress = BitmapDescriptorFactory.HUE_RED;
    ...
    private static class SubjectMock {
        ...
        public static SubjectMock mock(Bitmap bitmap) {
            ...
            new Canvas(subjectMock.bitmap).drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, subjectMock.width, subjectMock.height, Theme.DEBUG_RED);
    ...
    public StickerMakerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.segmentBorderAlpha = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, (View) null, 0L, 420L, cubicBezierInterpolator);
        this.outlineAlpha = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, (View) null, 0L, 420L, cubicBezierInterpolator);
        ...
        paintWeightChooserView.setAlpha(BitmapDescriptorFactory.HUE_RED);
    ...
    public /* synthetic */ void lambda$segmentImage$4(ArrayList arrayList) {
        ...
        if (segmentedObjectArr.length > 0) {
            ...
            this.stickerCutOutBtn.setAlpha(BitmapDescriptorFactory.HUE_RED);
    ...
    public /* synthetic */ void lambda$segmentImage$5(int i, List list, final ArrayList arrayList, final Utilities.Callback callback) {
        ...
        if (list.isEmpty()) {
            ...
            segmentedObject.bounds.set(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.sourceBitmap.getWidth(), this.sourceBitmap.getHeight());
    ...
    private void segment(final Bitmap bitmap, final int i, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        client.process(inputImageFromBitmap).addOnSuccessListener(new OnSuccessListener() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda7
        ...
        if (this.detectedEmoji == null) {
            ImageLabeling.getClient(ImageLabelerOptions.DEFAULT_OPTIONS).process(inputImageFromBitmap).addOnSuccessListener(new OnSuccessListener() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda9
                @Override // com.google.android.gms.tasks.OnSuccessListener
                public final void onSuccess(Object obj) {
    ...
    public void clean() {
        ...
        this.actionTextView.setAlpha(BitmapDescriptorFactory.HUE_RED);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i != NotificationCenter.fileUploadProgressChanged) {
            if (i == NotificationCenter.fileUploadFailed) {
                ...
                if (i == NotificationCenter.fileNewChunkAvailable) {
                    ...
                    FileLoader.getInstance(this.currentAccount).checkUploadNewDataAvailable(str3, false, Math.max(1L, jLongValue), jLongValue2, f);
                    StickerUploader stickerUploader6 = this.stickerUploader;
                    stickerUploader6.convertingProgress = Math.max(stickerUploader6.convertingProgress, fFloatValue);
        ...
        long jLongValue3 = ((Long) objArr[1]).longValue();
        long jLongValue4 = ((Long) objArr[2]).longValue();
        if (jLongValue4 <= 0) {
            return;
        }
        StickerUploader stickerUploader8 = this.stickerUploader;
        stickerUploader8.uploadProgress = Utilities.clamp(jLongValue3 / jLongValue4, 1.0f, stickerUploader8.uploadProgress);
        preparingVideoToast = this.loadingToast;
        if (preparingVideoToast == null) {
            return;
        }
    ...
    public void disableClippingMode() {
        this.segmentBorderAlpha.set(BitmapDescriptorFactory.HUE_RED);
        ValueAnimator valueAnimator = this.bordersAnimator;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.bordersAnimator = null;
        ...
        this.actionTextView.animate().alpha(BitmapDescriptorFactory.HUE_RED).scaleX(0.7f).scaleY(0.7f).setDuration(240L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
    }
    ...
    */
    ...
    public void drawOutline(Canvas canvas, boolean z, ViewGroup viewGroup, boolean z2) {
        ...
        if (this.outlineVisible || this.outlineAlpha.get() > BitmapDescriptorFactory.HUE_RED) {
    ...
    public void drawSegmentBorderPath(Canvas canvas, ImageReceiver imageReceiver, Matrix matrix, ViewGroup viewGroup) {
        ...
        if ((this.bordersAnimator != null || this.segmentBorderAlpha.get() > BitmapDescriptorFactory.HUE_RED) && viewGroup != null) {
    ...
    public void enableClippingMode(final Utilities.Callback callback) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.StickerMakerView$$ExternalSyntheticLambda4
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.bgPath.rewind();
        this.bgPath.addRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getMeasuredWidth(), getMeasuredHeight(), direction);
    ...
    public void setOutlineVisible(boolean z) {
        ...
        ViewPropertyAnimator viewPropertyAnimatorAnimate = this.weightChooserView.animate();
        ...
        viewPropertyAnimatorAlpha.translationX(fDp).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(320L).start();
        if (getParent() instanceof View) {
            ((View) getParent()).invalidate();
        }
        if (Build.VERSION.SDK_INT >= 29) {
