...
public abstract class DialogsChannelsAdapter extends UniversalAdapter {
    ...
    public /* synthetic */ void lambda$searchMessages$3(TLRPC.TL_contacts_search tL_contacts_search, TLObject tLObject) {
        ...
        if (cachedChannelRecommendations != null && !cachedChannelRecommendations.chats.isEmpty()) {
            ...
            while (it2.hasNext()) {
                TLObject next = it2.next();
                if (next instanceof TLRPC.Chat) {
                    TLRPC.Chat chat3 = (TLRPC.Chat) next;
        ...
        if (tL_contacts_found != null) {
            Iterator it3 = tL_contacts_found.results.iterator();
            while (it3.hasNext()) {
                TLRPC.Peer peer2 = (TLRPC.Peer) it3.next();
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        UItem uItemAsGraySection;
        UItem uItemAsGraySection2;
        int i = 0;
        if (TextUtils.isEmpty(this.query)) {
            ArrayList arrayList2 = this.myChannels;
            if (arrayList2 != null && !arrayList2.isEmpty()) {
                if (this.myChannels.size() > 5) {
                    uItemAsGraySection2 = UItem.asGraySection(LocaleController.getString(R.string.SearchMyChannels), LocaleController.getString(this.expandedMyChannels ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda5
                    ...
                    uItemAsGraySection2 = UItem.asGraySection(LocaleController.getString(R.string.SearchMyChannels));
                }
                arrayList.add(uItemAsGraySection2);
            ...
            arrayList.add(UItem.asFlicker(29));
            arrayList.add(UItem.asFlicker(29));
            uItemAsFlicker = UItem.asFlicker(29);
        } else {
            ...
            if (!arrayList4.isEmpty()) {
                if (arrayList4.size() <= 5 || this.messages.isEmpty()) {
                    uItemAsGraySection = UItem.asGraySection(LocaleController.getString(R.string.SearchChannels));
                } else {
                    uItemAsGraySection = UItem.asGraySection(LocaleController.getString(R.string.SearchChannels), LocaleController.getString(this.expandedSearchChannels ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda6
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                ...
                arrayList.add(uItemAsGraySection);
            ...
            if (!this.hasMore) {
                ...
                uItemAsFlicker = UItem.asFlicker(1);
            }
        }
