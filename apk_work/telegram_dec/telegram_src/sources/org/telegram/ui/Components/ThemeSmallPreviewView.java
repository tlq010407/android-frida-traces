...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        ...
        addView(backupImageView, LayoutHelper.createFrame(i3, f3, 81, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, f, f2));
    ...
    private void fillOutBubblePaint(Paint paint, List list) {
        ...
        if (list.size() > 1) {
            ...
            linearGradient = new LinearGradient(BitmapDescriptorFactory.HUE_RED, fDp, BitmapDescriptorFactory.HUE_RED, fDp + this.BUBBLE_HEIGHT, iArr, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            linearGradient = null;
        }
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        int i2 = iDp;
        StaticLayout staticLayoutCreateStaticLayout2 = StaticLayoutEx.createStaticLayout2(noThemeString(), this.noThemeTextPaint, i2, Layout.Alignment.ALIGN_CENTER, 1.0f, BitmapDescriptorFactory.HUE_RED, true, TextUtils.TruncateAt.END, i2, 3);
    ...
    private Drawable getPreviewDrawable(EmojiThemes.ThemeItem themeItem) throws IOException {
        MotionBackgroundDrawable motionBackgroundDrawable;
        int patternColor;
        Drawable motionBackgroundDrawable2 = null;
        ...
        if (themeItem.themeInfo.getAccent(false) != null) {
            if (i2 != 0) {
                MotionBackgroundDrawable motionBackgroundDrawable3 = new MotionBackgroundDrawable(i, i2, i3, i4, i5, true);
                patternColor = motionBackgroundDrawable.getPatternColor();
            ...
            motionBackgroundDrawable2 = new MotionBackgroundDrawable(i, i2, i3, i4, i5, true);
        } else if (i != 0) {
            motionBackgroundDrawable2 = new ColorDrawable(i);
        } else {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 != 1 && i3 != 4) {
            size = AndroidUtilities.dp(i3 == 0 ? 77.0f : 83.0f);
            ...
            if (tlTheme != null) {
                ...
                if (wallpaper != null) {
                    ...
                    chatThemeItem.chatTheme.loadWallpaperThumb(this.lastThemeIndex, new ResultCallback() { // from class: org.telegram.ui.Components.ThemeSmallPreviewView$$ExternalSyntheticLambda2
                        ...
                        public final void onComplete(Object obj) {
                            this.f$0.lambda$setItem$0(j, chatThemeItem, i3, (Pair) obj);
                        }
                ...
                if (themeAccent != null && (tL_theme = themeAccent.info) != null && tL_theme.settings.size() > 0) {
                    ...
                    if (wallPaper2 != null && (document = wallPaper2.document) != null) {
                        ImageLocation forDocument = ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, R.styleable.AppCompatTheme_windowFixedHeightMajor), document);
