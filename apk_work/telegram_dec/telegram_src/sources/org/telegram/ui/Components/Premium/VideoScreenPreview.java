                ...
                if (matrixParticlesDrawable != null) {
                    ...
                    if (drawable != null) {
                        ...
                        if (this.videoPlayerBase != null) {
                            float fClamp = Utilities.clamp(r0.getCurrentPosition() / this.videoPlayerBase.getDuration(), 1.0f, BitmapDescriptorFactory.HUE_RED);
                        ...
                        float fClamp2 = ((1.0f - Utilities.clamp(this.progress / 0.1f, 1.0f, BitmapDescriptorFactory.HUE_RED)) * 0.9f) + 0.1f;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.dp(BitmapDescriptorFactory.HUE_RED), getMeasuredHeight() * 0.1f);
