...
public class BoostTypeCell extends BaseCell {
    ...
    protected void updateLayouts() {
        this.imageView.setLayoutParams(LayoutHelper.createFrame(40, 40.0f, (LocaleController.isRTL ? 5 : 3) | 16, 57.0f, BitmapDescriptorFactory.HUE_RED, 57.0f, BitmapDescriptorFactory.HUE_RED));
        SimpleTextView simpleTextView = this.titleTextView;
        boolean z = LocaleController.isRTL;
        simpleTextView.setLayoutParams(LayoutHelper.createFrame(-1, -2.0f, (z ? 5 : 3) | 16, z ? 20.0f : 109.0f, BitmapDescriptorFactory.HUE_RED, z ? 109.0f : 20.0f, BitmapDescriptorFactory.HUE_RED));
        SimpleTextView simpleTextView2 = this.subtitleTextView;
        boolean z2 = LocaleController.isRTL;
        simpleTextView2.setLayoutParams(LayoutHelper.createFrame(-1, -2.0f, (z2 ? 5 : 3) | 16, z2 ? 20.0f : 109.0f, BitmapDescriptorFactory.HUE_RED, z2 ? 109.0f : 20.0f, BitmapDescriptorFactory.HUE_RED));
        this.radioButton.setLayoutParams(LayoutHelper.createFrame(22, 22.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, BitmapDescriptorFactory.HUE_RED, 15.0f, BitmapDescriptorFactory.HUE_RED));
    }
}
