...
public class VoIPEllipsizeSpan extends ReplacementSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        for (int i6 = 0; i6 < 3; i6++) {
            ...
            canvas.drawCircle(AndroidUtilities.dpf2((this.interpolator.getInterpolation(fMin) * 16.0f) + 1.667f), AndroidUtilities.dp(3.0f), AndroidUtilities.dpf2((fMin <= 0.425f ? this.interpolator.getInterpolation(fMin / 0.425f) : 1.0f - this.interpolator.getInterpolation((fMin - 0.425f) / 0.575f)) * 2.0f), paint);
        }
        canvas.restore();
