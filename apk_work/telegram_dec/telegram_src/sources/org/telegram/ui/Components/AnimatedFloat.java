...
public class AnimatedFloat {
    ...
    public void force(boolean z) {
        set(z ? 1.0f : BitmapDescriptorFactory.HUE_RED, true);
    }
    ...
    public float getTransitionProgress() {
        return !this.transition ? BitmapDescriptorFactory.HUE_RED : MathUtils.clamp(((SystemClock.elapsedRealtime() - this.transitionStart) - this.transitionDelay) / this.transitionDuration, BitmapDescriptorFactory.HUE_RED, 1.0f);
    }
    ...
    public float getValue() {
        if (this.transition) {
            ...
            if (jElapsedRealtime - this.transitionStart >= this.transitionDelay) {
                TimeInterpolator timeInterpolator = this.transitionInterpolator;
                this.value = timeInterpolator == null ? AndroidUtilities.lerp(this.startValue, this.targetValue, fClamp) : AndroidUtilities.lerp(this.startValue, this.targetValue, timeInterpolator.getInterpolation(fClamp));
            }
            if (fClamp >= 1.0f) {
