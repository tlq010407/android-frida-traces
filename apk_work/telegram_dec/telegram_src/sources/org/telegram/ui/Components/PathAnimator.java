        ...
        try {
            ...
            while (i < strArrSplit.length) {
                ...
                if (cCharAt == 'C') {
                    ...
                    curveTo2.x1 = (Float.parseFloat(strArrSplit[i + 1]) + this.tx) * this.scale;
                    curveTo2.y1 = (Float.parseFloat(strArrSplit[i + 2]) + this.ty) * this.scale;
                    curveTo2.x2 = (Float.parseFloat(strArrSplit[i + 3]) + this.tx) * this.scale;
                    curveTo2.y2 = (Float.parseFloat(strArrSplit[i + 4]) + this.ty) * this.scale;
                    curveTo2.x = (Float.parseFloat(strArrSplit[i + 5]) + this.tx) * this.scale;
                    i += 6;
                    curveTo2.y = (Float.parseFloat(strArrSplit[i]) + this.ty) * this.scale;
                    curveTo = curveTo2;
                } else if (cCharAt == 'L') {
