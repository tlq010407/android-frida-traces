...
public class LinkCell extends FrameLayout {
    ...
    public LinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(this.linkContainer, LayoutHelper.createFrame(-1, -2.0f, 0, 14.0f, BitmapDescriptorFactory.HUE_RED, 14.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.imageView, LayoutHelper.createFrame(40, 40.0f, 21, 15.0f, BitmapDescriptorFactory.HUE_RED, 17.0f, BitmapDescriptorFactory.HUE_RED));
