...
public class StarGiveawayOptionCell extends FrameLayout {
    ...
    public StarGiveawayOptionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(this.titleView, LayoutHelper.createFrame(-1, 20.0f, 51, 64.0f, 8.0f, 80.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.subtitleView, LayoutHelper.createFrame(-1, 14.0f, 51, 64.0f, 31.0f, 80.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.priceView, LayoutHelper.createFrame(-2, -2.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 19.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.radioButton, LayoutHelper.createFrame(20, 20.0f, 19, 22.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
    }
