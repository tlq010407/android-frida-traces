...
public class CellFlickerDrawable {
    ...
    public class DrawableInterface extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (svgDrawable != null) {
                ...
                CellFlickerDrawable.this.matrix.setScale(1.0f / scale, BitmapDescriptorFactory.HUE_RED, r2.size / 2.0f, BitmapDescriptorFactory.HUE_RED);
    ...
    public CellFlickerDrawable(int i, int i2, int i3) {
        ...
        this.gradientShader = new LinearGradient(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED, iArr, (float[]) null, tileMode);
        this.gradientShader2 = new LinearGradient(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.size, BitmapDescriptorFactory.HUE_RED, new int[]{0, ColorUtils.setAlphaComponent(-1, i2), 0}, (float[]) null, tileMode);
    ...
    public void draw(Canvas canvas, GroupCallMiniTextureView groupCallMiniTextureView) {
        ...
        int i = this.parentWidth;
        this.matrix.setTranslate((((i + (r2 * 2)) * f2) - this.size) - groupCallMiniTextureView.getX(), BitmapDescriptorFactory.HUE_RED);
        this.gradientShader.setLocalMatrix(this.matrix);
        this.gradientShader2.setLocalMatrix(this.matrix);
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    public void setColors(int i, int i2, int i3) {
        ...
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        this.gradientShader = new LinearGradient(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED, iArr, (float[]) null, tileMode);
        this.gradientShader2 = new LinearGradient(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, this.size, BitmapDescriptorFactory.HUE_RED, new int[]{0, ColorUtils.setAlphaComponent(i, i3), 0}, (float[]) null, tileMode);
        this.paint.setShader(this.gradientShader);
        this.paintOutline.setShader(this.gradientShader2);
    }
