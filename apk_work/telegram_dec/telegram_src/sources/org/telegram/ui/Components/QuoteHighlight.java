...
public class QuoteHighlight extends Path {
    ...
    public QuoteHighlight(final View view, final ViewParent viewParent, int i, ArrayList arrayList, int i2, int i3, float f) {
        ...
        this.cell = null;
        this.t = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, new Runnable() { // from class: org.telegram.ui.Components.QuoteHighlight$$ExternalSyntheticLambda0
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            if (textLayoutBlock != null && i2 <= textLayoutBlock.charactersEnd && i3 >= (i4 = textLayoutBlock.charactersOffset)) {
                ...
                this.minX = textLayoutBlock.quote ? AndroidUtilities.dp(10.0f) : BitmapDescriptorFactory.HUE_RED;
    ...
    public QuoteHighlight(final ChatMessageCell chatMessageCell, int i, int i2) {
        ...
        this.t = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, new Runnable() { // from class: org.telegram.ui.Components.QuoteHighlight$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
