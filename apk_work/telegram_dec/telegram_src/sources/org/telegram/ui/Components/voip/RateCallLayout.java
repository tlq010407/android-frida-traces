...
public class RateCallLayout extends FrameLayout {
    ...
    public static class RateCallContainer extends FrameLayout {
        ...
        public RateCallContainer(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            addView(textView, LayoutHelper.createFrame(-1, -2.0f, 3, BitmapDescriptorFactory.HUE_RED, 24.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
            addView(textView2, LayoutHelper.createFrame(-1, -2.0f, 3, BitmapDescriptorFactory.HUE_RED, 50.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        }
    ...
    public RateCallLayout(final Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            this.starsContainer.addView(this.startsViews[i], LayoutHelper.createFrame(-2, -2.0f, 51, i * 41, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        }
        addView(this.rateCallContainer, LayoutHelper.createFrame(LocationRequest.PRIORITY_INDOOR, 152.0f, 49, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        addView(this.starsContainer, LayoutHelper.createFrame(NotificationCenter.smsJobStatusUpdate, 100.0f, 49, BitmapDescriptorFactory.HUE_RED, 90.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
    }
    ...
    public void show(OnRateSelected onRateSelected) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) View.SCALE_X, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) View.SCALE_Y, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(24.0f), BitmapDescriptorFactory.HUE_RED));
        animatorSet.setInterpolator(CubicBezierInterpolator.DEFAULT);
        animatorSet.setDuration(250L);
        for (int i = 0; i < this.startsViews.length; i++) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.startsViews[i].setAlpha(BitmapDescriptorFactory.HUE_RED);
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) View.ALPHA, BitmapDescriptorFactory.HUE_RED, 1.0f), ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) View.SCALE_X, 0.3f, 1.0f), ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) View.SCALE_Y, 0.3f, 1.0f), ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(30.0f), BitmapDescriptorFactory.HUE_RED));
