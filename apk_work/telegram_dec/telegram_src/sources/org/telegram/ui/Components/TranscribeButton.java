...
public abstract class TranscribeButton {
    ...
    private void addCorner(Path path, int i, int i2, int i3, int i4, float f, float f2) {
        ...
        float fClamp2 = MathUtils.clamp(f2, BitmapDescriptorFactory.HUE_RED, 1.0f) - fClamp;
        if (fClamp2 <= BitmapDescriptorFactory.HUE_RED) {
            return;
        }
        if (i4 != 1) {
            if (i4 == 2) {
    ...
    private void addCorner(Path path, int i, int i2, int i3, int i4, float f, float f2, float f3, float f4) {
        if (f <= f2) {
            float f5 = f4 - f3;
            addCorner(path, i, i2, i3, i4, Math.max(BitmapDescriptorFactory.HUE_RED, f - f3) / f5, (Math.min(f2, f4) - f3) / f5);
        } else {
            float f6 = f4 - f3;
            addCorner(path, i, i2, i3, i4, (f - f3) / f6, 1.0f);
            addCorner(path, i, i2, i3, i4, BitmapDescriptorFactory.HUE_RED, (f2 - f3) / f6);
        }
    }
    ...
    private void addLine(Path path, int i, int i2, int i3, int i4, float f, float f2) {
        ...
        float fClamp = MathUtils.clamp(f, BitmapDescriptorFactory.HUE_RED, 1.0f);
        if (MathUtils.clamp(f2, BitmapDescriptorFactory.HUE_RED, 1.0f) - fClamp <= BitmapDescriptorFactory.HUE_RED) {
            return;
        }
    ...
    private void addLine(Path path, int i, int i2, int i3, int i4, float f, float f2, float f3, float f4) {
        ...
        if (f > f2) {
            ...
            float f6 = f4 - f3;
            fMax = Math.max(BitmapDescriptorFactory.HUE_RED, f - f3) / f6;
            fMin = (Math.min(f2, f4) - f3) / f6;
        }
        addLine(path, i, i2, i3, i4, fMax, fMin);
    }
    ...
    public void draw(Canvas canvas, float f) {
        ...
        canvas.restore();
        float f4 = this.loadingFloat.set(this.loading ? 1.0f : BitmapDescriptorFactory.HUE_RED);
        if (f4 > BitmapDescriptorFactory.HUE_RED) {
            ...
            float f5 = segments[0] + ((1.0f - f4) * fMax * (this.loading ? BitmapDescriptorFactory.HUE_RED : 1.0f));
            float f6 = (fMax * f4) + f5;
            float f7 = f5 % 360.0f;
            float f8 = f6 % 360.0f;
            ...
            int i = rect.top;
            addLine(path4, iCenterX, i, rect.right - this.radius, i, f9, f10, BitmapDescriptorFactory.HUE_RED, this.a);
    ...
    public void setLoading(boolean z, boolean z2) {
        ...
        } else if (animatedFloat.get() <= BitmapDescriptorFactory.HUE_RED) {
