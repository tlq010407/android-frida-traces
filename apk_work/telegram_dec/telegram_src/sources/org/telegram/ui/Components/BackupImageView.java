...
public class BackupImageView extends View {
    ...
    public BackupImageView(Context context) {
        ...
        imageReceiverCreateImageReciever.setCrossfadeByScale(BitmapDescriptorFactory.HUE_RED);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i2 = this.width;
        if (i2 == -1 || (i = this.height) == -1) {
            imageReceiver2.setImageCoords(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, getWidth(), getHeight());
            if (this.blurAllowed) {
                imageReceiver = this.blurImageReceiver;
                width = getWidth();
                height = getHeight();
                imageReceiver.setImageCoords(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, width, height);
            }
        } else if (this.drawFromStart) {
            imageReceiver2.setImageCoords(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, i2, i);
            if (this.blurAllowed) {
                imageReceiver = this.blurImageReceiver;
                width = this.width;
                height = this.height;
