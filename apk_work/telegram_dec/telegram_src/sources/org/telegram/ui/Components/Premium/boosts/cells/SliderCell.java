...
public class SliderCell extends FrameLayout {
    ...
    public SliderCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(slideChooseView, LayoutHelper.createFrame(-1, -1.0f, 48, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
