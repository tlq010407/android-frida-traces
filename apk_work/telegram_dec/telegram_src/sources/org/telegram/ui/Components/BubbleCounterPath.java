...
public abstract class BubbleCounterPath {
    ...
    public static void addBubbleRect(Path path, RectF rectF, float f) {
        ...
        path.cubicTo(AndroidUtilities.dp(-0.334f), AndroidUtilities.dp(-1.571f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(-1.155f), AndroidUtilities.dp(-0.06f), AndroidUtilities.dp(-1.154f));
        ...
        float f3 = -f;
        path.quadTo(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(2.187f) + f3, BitmapDescriptorFactory.HUE_RED, f3);
        path.close();
