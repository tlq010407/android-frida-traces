    ...
    class CanvasInternal extends DispatchQueue {
        ...
        private void checkBitmap() {
            ...
            if (RenderView.this.bitmap.getWidth() != size.width || RenderView.this.bitmap.getHeight() != size.height) {
                ...
                new Canvas(bitmapCreateBitmap).drawBitmap(RenderView.this.bitmap, (Rect) null, new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, size.width, size.height), (Paint) null);
            ...
            if (RenderView.this.blurBitmap != null) {
                ...
                new Canvas(bitmapCreateBitmap2).drawBitmap(RenderView.this.blurBitmap, (Rect) null, new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, size.width, size.height), (Paint) null);
