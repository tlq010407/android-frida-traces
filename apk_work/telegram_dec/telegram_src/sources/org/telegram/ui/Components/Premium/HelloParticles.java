    ...
    public static class Drawable {
        ...
        private class Particle {
            ...
            public void genPosition(long j, int i, boolean z) {
                ...
                if (i2 == 0) {
                    f3 = fCenterX - (this.w / 2.0f);
                } else {
                    f2 = (this.w / 2.0f) + fCenterX;
                }
                float f4 = f3 - f2;
                float fAbs = Math.abs(Utilities.fastRandom.nextInt() % f4) + f2;
                float fAbs2 = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                float f5 = BitmapDescriptorFactory.HUE_RED;
                for (int i3 = 0; i3 < 10; i3++) {
                    float fAbs3 = Math.abs(Utilities.fastRandom.nextInt() % f4) + f2;
                    ...
                    for (int i4 = 0; i4 < Drawable.this.particles.size(); i4++) {
                        ...
                        if (particle.set) {
                            ...
                            float f7 = particle.y - fAbs4;
                            float f8 = (fMin * fMin) + (f7 * f7);
                            if (f8 < f6) {
                                f6 = f8;
                            }
                        }
