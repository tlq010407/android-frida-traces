...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void addIconTab(final int i, Drawable drawable, CharSequence charSequence) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            RippleDrawable rippleDrawableM = Theme$$ExternalSyntheticApiModelOutline0.m(Theme.createSelectorDrawable(getThemedColor(Theme.key_chat_emojiBottomPanelIcon), 1, AndroidUtilities.dp(18.0f)));
            Theme.setRippleDrawableForceSoftware(rippleDrawableM);
            imageView.setBackground(rippleDrawableM);
        }
    ...
    private void addTab(final int i, CharSequence charSequence) {
        ...
        this.tabsContainer.addView(textTab, LayoutHelper.createLinear(-2, -2, 10.0f, BitmapDescriptorFactory.HUE_RED, 10.0f, BitmapDescriptorFactory.HUE_RED));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addTab$1(int i, View view) throws Resources.NotFoundException {
        if (!(this.pager.getAdapter() instanceof IconTabProvider) || ((IconTabProvider) this.pager.getAdapter()).canScrollToTab(i)) {
            this.pager.setCurrentItem(i, false);
        }
    }
