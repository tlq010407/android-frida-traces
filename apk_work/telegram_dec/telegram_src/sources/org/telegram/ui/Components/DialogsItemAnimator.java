    ...
    */
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        if (!(view instanceof DialogCell)) {
            ...
            viewPropertyAnimatorAnimate.setDuration(180L).alpha(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.3
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.mPendingAdditions.size() > 2) {
            for (int i = 0; i < this.mPendingAdditions.size(); i++) {
                ((RecyclerView.ViewHolder) this.mPendingAdditions.get(i)).itemView.setAlpha(BitmapDescriptorFactory.HUE_RED);
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(view, (Property<View, Float>) property, BitmapDescriptorFactory.HUE_RED), ObjectAnimator.ofFloat(viewHolder2.itemView, (Property<View, Float>) property, 1.0f));
