...
public class SideMenultItemAnimator extends SimpleItemAnimator {
    ...
    void animateAddImpl(final RecyclerView.ViewHolder viewHolder, int i, int i2, int i3) {
        ...
        viewPropertyAnimatorAnimate.translationY(BitmapDescriptorFactory.HUE_RED).setDuration(220L).setInterpolator(CubicBezierInterpolator.EASE_OUT).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SideMenultItemAnimator.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(BitmapDescriptorFactory.HUE_RED).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SideMenultItemAnimator.4
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
        ...
        if (view2 != null) {
            ...
            viewPropertyAnimatorAnimate.translationX(BitmapDescriptorFactory.HUE_RED).translationY(BitmapDescriptorFactory.HUE_RED).setDuration(getChangeAddDuration()).setStartDelay(getChangeDuration() - getChangeAddDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SideMenultItemAnimator.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    viewPropertyAnimatorAnimate.setListener(null);
                    view2.setAlpha(1.0f);
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    measuredHeight2 += ((RecyclerView.ViewHolder) arrayList3.get(i3)).itemView.getMeasuredHeight();
                }
                int size4 = arrayList3.size();
                for (int i4 = 0; i4 < size4; i4++) {
                    animateAddImpl((RecyclerView.ViewHolder) arrayList3.get(i4), i4, size4, measuredHeight2);
                }
                arrayList3.clear();
