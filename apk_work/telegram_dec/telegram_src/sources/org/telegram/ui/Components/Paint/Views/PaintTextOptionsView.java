...
public class PaintTextOptionsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final class TypefaceCell extends TextView {
        ...
        public void setCurrent(boolean z) {
            ...
            if (z) {
                ...
                drawableRect = Theme.AdaptiveRipple.rect(1090519039, AndroidUtilities.dp(32.0f));
            } else {
                setPadding(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(24.0f), AndroidUtilities.dp(14.0f));
                drawableRect = Theme.AdaptiveRipple.rect(-14145495);
            }
            setBackground(drawableRect);
    ...
    public PaintTextOptionsView(Context context) {
        ...
        addView(this.colorClickableView, LayoutHelper.createFrame(24, 24.0f, 48, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.alignView, LayoutHelper.createFrame(28, 28.0f, 16, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.outlineView, LayoutHelper.createFrame(28, 28.0f, 16, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(this.plusView, LayoutHelper.createFrame(28, 28.0f, 16, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 16.0f, BitmapDescriptorFactory.HUE_RED));
