...
public abstract class BotButtons extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRect(BitmapDescriptorFactory.HUE_RED, height - 1.0f, getWidth(), height, this.separatorPaint);
        this.backgroundPaint.setColor(this.background.set(this.state.backgroundColor));
        canvas.drawRect(BitmapDescriptorFactory.HUE_RED, height, getWidth(), getHeight(), this.backgroundPaint);
        ...
        while (true) {
            ...
            if (buttonState.visible) {
                ...
                f5 = animatedFloat3.set((buttonsState4.secondary.visible && buttonsState4.main.visible && ("left".equalsIgnoreCase(str) || "right".equalsIgnoreCase(str))) ? BitmapDescriptorFactory.HUE_RED : 1.0f);
            } else {
                f5 = button.w.get();
            }
            ...
            if (f9 < 1.0f) {
                ...
                canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(-10.0f) * f9);
            ...
            if (f9 > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.translate(BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(10.0f) * (1.0f - f9));
