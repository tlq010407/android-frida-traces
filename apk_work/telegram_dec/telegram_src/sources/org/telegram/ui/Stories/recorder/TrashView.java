...
public class TrashView extends View {
    ...
    public TrashView(Context context) {
        ...
        paint.setShadowLayer(AndroidUtilities.dpf2(3.0f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(1.66f), 805306368);
        ...
        animatedTextDrawable.setShadowLayer(AndroidUtilities.dpf2(1.33f), BitmapDescriptorFactory.HUE_RED, AndroidUtilities.dp(1.0f), 1073741824);
