...
public class DownloadButton extends ImageView {
    ...
    public static class PreparingVideoToast extends View {
        ...
        public PreparingVideoToast(Context context, String str) {
            ...
            this.shown = false;
            this.showT = new AnimatedFloat(BitmapDescriptorFactory.HUE_RED, this, 0L, 350L, CubicBezierInterpolator.EASE_OUT_QUINT);
            this.preparing = true;
            ...
            this.preparingLayoutLeft = staticLayout.getLineCount() > 0 ? staticLayout.getLineLeft(i) : f;
            show();
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f2 = this.t.set(this.preparing ? BitmapDescriptorFactory.HUE_RED : 1.0f);
            float f3 = 1.0f - f2;
        ...
        public void setDone(int i, CharSequence charSequence, int i2) {
            ...
            this.doneLayoutWidth = lineCount > 0 ? this.doneLayout.getLineWidth(0) : BitmapDescriptorFactory.HUE_RED;
            if (this.doneLayout.getLineCount() > 0) {
                lineLeft = this.doneLayout.getLineLeft(0);
            }
            this.doneLayoutLeft = lineLeft;
    ...
    private void onClick() {
        ...
        if (i >= 23 && ((i <= 28 || BuildVars.NO_SCOPED_STORAGE) && getContext().checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") != 0)) {
            ...
            if (activityFindActivity != null) {
                activityFindActivity.requestPermissions(new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, R.styleable.AppCompatTheme_toolbarStyle);
                return;
            }
            return;
        }
    ...
    public void onClickInternal() {
        ...
        if (storyEntry.wouldBeVideo()) {
            ...
            this.buildingVideo = new BuildingVideo(this.currentAccount, this.currentEntry, fileGenerateVideoPath, new Runnable() { // from class: org.telegram.ui.Stories.recorder.DownloadButton$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
