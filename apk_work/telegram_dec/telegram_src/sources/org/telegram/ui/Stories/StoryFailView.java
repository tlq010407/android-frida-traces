...
public class StoryFailView extends FrameLayout {
    ...
    public StoryFailView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(textView, LayoutHelper.createFrame(-2, -2.0f, 19, 44.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView2, LayoutHelper.createFrame(-2, -2.0f, 19, 44.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(textView3, LayoutHelper.createFrame(-2, 32.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 12.0f, BitmapDescriptorFactory.HUE_RED));
    }
