...
public class ButtonWithCounterView extends FrameLayout implements Loadable {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.flickeringLoading) {
            if (this.loading) {
                if (this.flickeringLoadingDrawable == null) {
                    ...
                    this.flickeringLoadingDrawable.strokePaint.setStrokeWidth(BitmapDescriptorFactory.HUE_RED);
        ...
        if (f < 1.0f) {
            ...
            float fDp = this.withCounterIcon ? AndroidUtilities.dp(12.0f) : BitmapDescriptorFactory.HUE_RED;
            ...
            rect.offset(-AndroidUtilities.dp((this.countText.getText() != null ? this.countText.getText().length() : 0) > 1 ? 0.3f : BitmapDescriptorFactory.HUE_RED), -AndroidUtilities.dp(0.4f));
            ...
            if (this.countFilled && this.withCounterIcon) {
                ...
                canvas.translate(fDp / 2.0f, BitmapDescriptorFactory.HUE_RED);
            }
    ...
    public void setSubText(CharSequence charSequence, boolean z) {
        ...
        if (!this.subTextVisible || z2) {
            ...
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.subTextT, BitmapDescriptorFactory.HUE_RED);
    ...
    public void updateColors() {
        ...
        if (this.filled) {
            ...
            iMultAlpha = Theme.getColor(Theme.key_listSelector, this.resourcesProvider);
        } else {
            view = this.rippleView;
            iMultAlpha = Theme.multAlpha(this.text.getTextColor(), 0.1f);
        }
        view.setBackground(Theme.createRadSelectorDrawable(iMultAlpha, 8, 8));
