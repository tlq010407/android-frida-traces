...
public class StoryContainsEmojiButton extends View {
    ...
    private void set(TLRPC.StickerSetCovered stickerSetCovered) {
        ...
        boolean z = this.emoji;
        setText(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString((z && this.stickers) ? R.string.StoryContainsStickersEmojiFrom : z ? R.string.StoryContainsEmojiFrom : R.string.StoryContainsStickersFrom), charSequenceSubSequence));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.layout != null) {
            ...
            if (f2 > BitmapDescriptorFactory.HUE_RED) {
                ...
                canvas.translate(paddingLeft2 - f3, getPaddingTop());
    ...
    public void setText(CharSequence charSequence) {
        ...
        this.layoutLeft = lineCount > 0 ? this.layout.getLineLeft(0) : BitmapDescriptorFactory.HUE_RED;
        if (this.layout.getLineCount() > 0) {
            lineWidth = this.layout.getLineWidth(0);
        }
        this.layoutWidth = lineWidth;
