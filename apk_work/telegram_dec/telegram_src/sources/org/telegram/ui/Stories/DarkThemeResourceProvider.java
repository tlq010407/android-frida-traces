...
public class DarkThemeResourceProvider implements Theme.ResourcesProvider {
    ...
    public DarkThemeResourceProvider() {
        ...
        this.sparseIntArray.put(Theme.key_chat_messagePanelBackground, ColorUtils.setAlphaComponent(-16777216, R.styleable.AppCompatTheme_windowFixedWidthMajor));
        ...
        this.sparseIntArray.put(Theme.key_chat_emojiSearchIcon, ColorUtils.setAlphaComponent(-1, R.styleable.AppCompatTheme_windowMinWidthMinor));
        this.sparseIntArray.put(Theme.key_chat_emojiPanelIcon, -2130706433);
        this.sparseIntArray.put(Theme.key_chat_emojiBottomPanelIcon, ColorUtils.setAlphaComponent(-1, R.styleable.AppCompatTheme_windowMinWidthMinor));
        ...
        this.sparseIntArray.put(Theme.key_chat_emojiPanelBackspace, ColorUtils.setAlphaComponent(-1, R.styleable.AppCompatTheme_windowMinWidthMinor));
