...
public class StoryWidgetsImageDecorator extends ImageReceiver.Decorator {
    ...
    public class WeatherWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            ...
            float fMin = Math.min(f4 / ((this.marker.getWidthInternal() - this.marker.getPaddingLeft()) - this.marker.getPaddingRight()), ((float) ((d5 * d8) / 100.0d)) / ((this.marker.getHeightInternal() - this.marker.getPaddingTop()) - this.marker.getPaddingBottom()));
