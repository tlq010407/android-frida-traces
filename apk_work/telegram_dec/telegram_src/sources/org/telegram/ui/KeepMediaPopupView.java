...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    private class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            addView(this.titleView, LayoutHelper.createFrame(0, -2.0f, 19, 19.0f, BitmapDescriptorFactory.HUE_RED, 19.0f, BitmapDescriptorFactory.HUE_RED));
            ...
            addView(this.avatarsImageView, LayoutHelper.createFrame(56, -1.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 4.0f, BitmapDescriptorFactory.HUE_RED));
