        ...
        if (i3 == -1) {
            ...
            if (i3 == -2) {
                if (this.periods.isEmpty() || is24()) {
                    ...
                    int iClamp2 = Utilities.clamp(1200, this.max, iClamp + 1);
                    arrayList = this.periods;
                    period = new OpeningHoursActivity.Period(iClamp, iClamp2);
                } else {
                    ArrayList arrayList2 = this.periods;
                    int i4 = ((OpeningHoursActivity.Period) arrayList2.get(arrayList2.size() - 1)).end;
                    int iClamp3 = Utilities.clamp(i4 + 30, this.max - 1, this.min);
                    int iClamp4 = Utilities.clamp((i4 + 1560) / 2, this.max, iClamp3 + 1);
                    arrayList = this.periods;
                    period = new OpeningHoursActivity.Period(iClamp3, iClamp4);
                }
            ...
            if (i7 == 0) {
                AlertsCreator.createTimePickerDialog(getContext(), LocaleController.getString(R.string.BusinessHoursDayOpenHourPicker), period3.start, period2 == null ? this.min : period2.end + 1, period3.end - 1, new Utilities.Callback() { // from class: org.telegram.ui.Business.OpeningHoursDayActivity$$ExternalSyntheticLambda2
                    ...
                    public final void run(Object obj) {
                        this.f$0.lambda$onClick$0(view, period3, (Integer) obj);
                    }
                });
                return;
            }
            if (i7 == 1) {
                AlertsCreator.createTimePickerDialog(getContext(), LocaleController.getString(R.string.BusinessHoursDayCloseHourPicker), period3.end, period3.start + 1, period4 == null ? this.max : period4.start - 1, new Utilities.Callback() { // from class: org.telegram.ui.Business.OpeningHoursDayActivity$$ExternalSyntheticLambda3
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        this.f$0.lambda$onClick$1(view, period3, (Integer) obj);
                    }
                });
                return;
            }
