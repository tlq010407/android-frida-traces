...
import org.telegram.tgnet.tl.TL_account$toggleConnectedBotPaused;
...
public class BusinessBotButton extends FrameLayout {
    ...
    public BusinessBotButton(Context context, final ChatActivity chatActivity, final Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(backupImageView, LayoutHelper.createFrame(32, 32.0f, 19, 10.0f, BitmapDescriptorFactory.HUE_RED, 10.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        linearLayout.addView(animatedTextView, LayoutHelper.createLinear(-1, 17, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f));
        ...
        addView(linearLayout, LayoutHelper.createFrame(-2, -2.0f, 16, 52.0f, BitmapDescriptorFactory.HUE_RED, 49.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(clickableAnimatedTextView, LayoutHelper.createFrame(64, 28.0f, 21, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 49.0f, BitmapDescriptorFactory.HUE_RED));
        ...
        addView(imageView, LayoutHelper.createFrame(32, 32.0f, 21, 8.0f, BitmapDescriptorFactory.HUE_RED, 9.0f, BitmapDescriptorFactory.HUE_RED));
    }
    ...
    public /* synthetic */ void lambda$new$0(View view) {
        ...
        TL_account$toggleConnectedBotPaused tL_account$toggleConnectedBotPaused = new TL_account$toggleConnectedBotPaused();
        tL_account$toggleConnectedBotPaused.peer = MessagesController.getInstance(this.currentAccount).getInputPeer(this.dialogId);
        tL_account$toggleConnectedBotPaused.paused = this.paused;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account$toggleConnectedBotPaused, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$1() {
        TL_account$disablePeerConnectedBot tL_account$disablePeerConnectedBot = new TL_account$disablePeerConnectedBot();
        tL_account$disablePeerConnectedBot.peer = MessagesController.getInstance(this.currentAccount).getInputPeer(this.dialogId);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account$disablePeerConnectedBot, null);
