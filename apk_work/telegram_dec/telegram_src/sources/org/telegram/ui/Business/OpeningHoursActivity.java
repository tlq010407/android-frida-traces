    ...
    */
    public static ArrayList adaptWeeklyOpen(ArrayList arrayList, int i) {
        ...
        for (int i3 = 0; i3 < arrayList2.size(); i3++) {
            TL_account$TL_businessWeeklyOpen tL_account$TL_businessWeeklyOpen = (TL_account$TL_businessWeeklyOpen) arrayList2.get(i3);
            ...
            if (i != 0) {
                ...
                int i5 = i4 % 1440;
                int i6 = tL_account$TL_businessWeeklyOpen.end_minute;
                int i7 = (i6 - i4) + i5;
                if (i5 == 0 && (i7 == 1440 || i7 == 1439)) {
                    tL_account$TL_businessWeeklyOpen2.start_minute = i4;
                    tL_account$TL_businessWeeklyOpen2.end_minute = i6;
                } else {
                    ...
                    int i8 = tL_account$TL_businessWeeklyOpen2.start_minute;
                    int i9 = tL_account$TL_businessWeeklyOpen2.end_minute;
                    if (i8 < 0) {
                        if (i9 < 0) {
                            tL_account$TL_businessWeeklyOpen2.start_minute = i8 + 10080;
                            i2 = i9 + 10080;
                            tL_account$TL_businessWeeklyOpen2.end_minute = i2;
                        } else {
                            tL_account$TL_businessWeeklyOpen2.start_minute = 0;
                            tL_account$TL_businessWeeklyOpen2 = new TL_account$TL_businessWeeklyOpen();
                            tL_account$TL_businessWeeklyOpen2.start_minute = tL_account$TL_businessWeeklyOpen.start_minute + 10080 + i;
                        ...
                        if (i8 > 10080) {
                            ...
                            tL_account$TL_businessWeeklyOpen2 = new TL_account$TL_businessWeeklyOpen();
                            tL_account$TL_businessWeeklyOpen2.start_minute = 0;
                            tL_account$TL_businessWeeklyOpen2.end_minute = (tL_account$TL_businessWeeklyOpen.end_minute + i) - 10079;
                        }
                    }
                }
                arrayList3.add(tL_account$TL_businessWeeklyOpen2);
    ...
    public void onClick(final UItem uItem, final View view, int i, float f, float f2) {
        BaseFragment baseFragmentOnDone;
        int i2 = uItem.id;
        if (i2 != -1) {
            if (i2 == -2) {
                baseFragmentOnDone = new TimezoneSelector().setValue(this.timezoneId).whenSelected(new Utilities.Callback() { // from class: org.telegram.ui.Business.OpeningHoursActivity$$ExternalSyntheticLambda4
                ...
                if (!LocaleController.isRTL ? f < view.getMeasuredWidth() - AndroidUtilities.dp(76.0f) : f > AndroidUtilities.dp(76.0f)) {
                    ...
                    ArrayList[] arrayListArr = this.value;
                    int i10 = uItem.id;
                    baseFragmentOnDone = new OpeningHoursDayActivity(charSequence, arrayListArr[i10], iMax, i9, maxPeriodsFor(i10)).onApplied(new Runnable() { // from class: org.telegram.ui.Business.OpeningHoursActivity$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            presentFragment(baseFragmentOnDone);
            return;
        }
    ...
    public void processDone() {
        ...
        if (this.enabled && !arrayListFromDaysHours.isEmpty()) {
            ...
            tL_account$TL_businessWorkHours.weekly_open.addAll(arrayListFromDaysHours);
    ...
    public static String toString(int i, TLRPC.User user, TL_account$TL_businessWorkHours tL_account$TL_businessWorkHours) {
        ...
        TLRPC.TL_timezone tL_timezoneFindTimezone = TimezonesController.getInstance(i).findTimezone(tL_account$TL_businessWorkHours.timezone_id);
