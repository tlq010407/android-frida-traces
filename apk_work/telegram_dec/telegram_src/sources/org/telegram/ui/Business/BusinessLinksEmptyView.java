...
public class BusinessLinksEmptyView extends LinearLayout {
    ...
    public BusinessLinksEmptyView(Context context, final BaseFragment baseFragment, final TL_account$TL_businessChatLink tL_account$TL_businessChatLink, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        setOrientation(1);
        ...
        this.linkView.setText(BusinessLinksController.stripHttps(tL_account$TL_businessChatLink.link));
        ...
        this.linkView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Business.BusinessLinksEmptyView$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                BusinessLinksEmptyView.lambda$new$0(tL_account$TL_businessChatLink, baseFragment, view);
            }
        });
    ...
    public static /* synthetic */ void lambda$new$0(TL_account$TL_businessChatLink tL_account$TL_businessChatLink, BaseFragment baseFragment, View view) {
