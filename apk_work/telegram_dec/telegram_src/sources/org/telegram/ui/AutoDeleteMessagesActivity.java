    ...
    class AnonymousClass2 implements Runnable {
        ...
        public /* synthetic */ void lambda$run$0(ArrayList arrayList) {
            ...
            if (AutoDeleteMessagesActivity.this.getSelectedTime() > 0) {
                bulletinFactoryOf = BulletinFactory.of(AutoDeleteMessagesActivity.this);
                i = R.raw.fire_on;
                string = AndroidUtilities.replaceTags(LocaleController.formatString("AutodeleteTimerEnabledForChats", R.string.AutodeleteTimerEnabledForChats, LocaleController.formatTTLString(AutoDeleteMessagesActivity.this.getSelectedTime() * 60), LocaleController.formatPluralString("Chats", arrayList.size(), Integer.valueOf(arrayList.size()))));
            } else {
                bulletinFactoryOf = BulletinFactory.of(AutoDeleteMessagesActivity.this);
                i = R.raw.fire_off;
                string = LocaleController.formatString("AutodeleteTimerDisabledForChats", R.string.AutodeleteTimerDisabledForChats, LocaleController.formatPluralString("Chats", arrayList.size(), Integer.valueOf(arrayList.size())));
            }
