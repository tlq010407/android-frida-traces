...
public class ArchiveSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onFragmentDestroy() {
        ...
        if (this.changed) {
            ...
            tL_account$setGlobalPrivacySettings.settings = this.settings;
            getConnectionsManager().sendRequest(tL_account$setGlobalPrivacySettings, new RequestDelegate() { // from class: org.telegram.ui.ArchiveSettingsActivity$$ExternalSyntheticLambda0
