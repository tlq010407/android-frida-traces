...
public class TL_account$TL_businessGreetingMessage extends TLObject {
    public int no_activity_days;
    public TL_account$TL_businessRecipients recipients;
    public int shortcut_id;

    public static TL_account$TL_businessGreetingMessage TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        if (i != -451302485) {
            if (z) {
        ...
        tL_account$TL_businessGreetingMessage.readParams(inputSerializedData, z);
        return tL_account$TL_businessGreetingMessage;
    }
