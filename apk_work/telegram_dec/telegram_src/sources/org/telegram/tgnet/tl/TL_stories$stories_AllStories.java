...
public abstract class TL_stories$stories_AllStories extends TLObject {
    public static TL_stories$stories_AllStories TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        ...
        if (tL_stories$TL_stories_allStories != null) {
            tL_stories$TL_stories_allStories.readParams(inputSerializedData, z);
        }
