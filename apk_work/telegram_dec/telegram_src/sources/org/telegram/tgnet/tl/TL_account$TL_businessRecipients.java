...
public class TL_account$TL_businessRecipients extends TLObject {
    ...
    public static TL_account$TL_businessRecipients TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        if (i != 554733559) {
            if (z) {
        ...
        tL_account$TL_businessRecipients.readParams(inputSerializedData, z);
