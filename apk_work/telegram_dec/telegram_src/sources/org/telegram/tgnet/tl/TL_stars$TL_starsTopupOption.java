...
public class TL_stars$TL_starsTopupOption extends TLObject {
    ...
    public static TL_stars$TL_starsTopupOption TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        if (198776256 != i) {
            if (z) {
        ...
        tL_stars$TL_starsTopupOption.readParams(inputSerializedData, z);
