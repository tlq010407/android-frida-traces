...
public abstract class TL_stats$PostInteractionCounters extends TLObject {
    public static TL_stats$PostInteractionCounters TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        ...
        if (tL_stats$TL_postInteractionCountersMessage != null) {
            tL_stats$TL_postInteractionCountersMessage.readParams(inputSerializedData, z);
        }
