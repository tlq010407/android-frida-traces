...
public class TL_account$TL_inputBusinessRecipients extends TLObject {
    ...
    public static TL_account$TL_inputBusinessRecipients TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        if (i != 1871393450) {
            if (z) {
        ...
        tL_account$TL_inputBusinessRecipients.readParams(inputSerializedData, z);
