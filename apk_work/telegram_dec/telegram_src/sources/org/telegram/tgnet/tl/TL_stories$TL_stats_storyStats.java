...
public class TL_stories$TL_stats_storyStats extends TLObject {
    ...
    public static TL_stories$TL_stats_storyStats TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
        if (1355613820 != i) {
            if (z) {
        ...
        tL_stories$TL_stats_storyStats.readParams(inputSerializedData, z);
