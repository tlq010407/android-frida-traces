...
public class WebRtcAudioTrack {
            ...
            loop0: while (true) {
                ...
                while (this.keepAlive && WebRtcAudioTrack.this.audioTrack != null) {
                    try {
                        ...
                        jNanoTime = this.targetTimeNs - System.nanoTime();
    ...
    private int initPlayout(int i, int i2, double d) {
        ...
        try {
            AudioTrack audioTrackCreateAudioTrackOnLollipopOrHigher = Build.VERSION.SDK_INT >= 21 ? createAudioTrackOnLollipopOrHigher(i, iChannelCountToConfiguration, i3) : createAudioTrackOnLowerThanLollipop(i, iChannelCountToConfiguration, i3);
