...
public final class CipherSuite {
    ...
    static final Comparator ORDER_BY_NAME = new Comparator() { // from class: okhttp3.CipherSuite.1
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_textAppearancePopupMenuHeader);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
