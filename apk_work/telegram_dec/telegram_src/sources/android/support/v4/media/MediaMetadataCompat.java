...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static MediaMetadataCompat fromMediaMetadata(Object obj) {
        ...
        MediaMetadataCompat$$ExternalSyntheticApiModelOutline0.m(obj).writeToParcel(parcelObtain, 0);
        parcelObtain.setDataPosition(0);
        MediaMetadataCompat mediaMetadataCompatCreateFromParcel = CREATOR.createFromParcel(parcelObtain);
        parcelObtain.recycle();
        mediaMetadataCompatCreateFromParcel.mMetadataFwk = MediaMetadataCompat$$ExternalSyntheticApiModelOutline0.m(obj);
    ...
    public Object getMediaMetadata() {
        if (this.mMetadataFwk == null && Build.VERSION.SDK_INT >= 21) {
            ...
            parcelObtain.setDataPosition(0);
            this.mMetadataFwk = MediaMetadataCompat$$ExternalSyntheticApiModelOutline0.m(MediaMetadata.CREATOR.createFromParcel(parcelObtain));
            parcelObtain.recycle();
        }
