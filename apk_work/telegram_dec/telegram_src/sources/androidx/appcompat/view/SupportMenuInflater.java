...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemAlphabeticModifiers = tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_alphabeticModifiers, LiteMode.FLAG_ANIMATED_EMOJI_CHAT_NOT_PREMIUM);
            ...
            this.itemNumericModifiers = tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_numericModifiers, LiteMode.FLAG_ANIMATED_EMOJI_CHAT_NOT_PREMIUM);
            int i = R$styleable.MenuItem_android_checkable;
            this.itemCheckable = tintTypedArrayObtainStyledAttributes.hasValue(i) ? tintTypedArrayObtainStyledAttributes.getBoolean(i, false) : this.groupCheckable;
