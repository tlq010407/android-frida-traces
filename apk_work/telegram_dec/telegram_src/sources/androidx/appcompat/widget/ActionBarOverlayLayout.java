    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            windowInsetsCompatBuild = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
            this.mInnerInsets = windowInsetsCompatBuild;
        } else {
