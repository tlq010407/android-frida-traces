...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public int getId() {
            if (Build.VERSION.SDK_INT >= 21) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline2.m(this.mAction).getId();
            }
            return 0;
        }
        ...
        public CharSequence getLabel() {
            if (Build.VERSION.SDK_INT >= 21) {
                return AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline2.m(this.mAction).getLabel();
            }
            return null;
        }
    ...
    public String getUniqueId() {
        return BuildCompat.isAtLeastT() ? this.mInfo.getUniqueId() : Api19Impl.getExtras(this.mInfo).getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY");
    }
    ...
    public boolean removeAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            return this.mInfo.removeAction(AccessibilityNodeInfoCompat$$ExternalSyntheticApiModelOutline2.m(accessibilityActionCompat.mAction));
        }
        return false;
    }
