...
final class b extends HuaweiApiAvailability {
    ...
    public PendingIntent b(Context context, int i) {
        ...
        if (intentA != null) {
            return PendingIntent.getActivity(context, 0, intentA, ConnectionsManager.FileTypeFile);
        }
        return null;
    }
    ...
    public Task checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr) {
        Task task = new TaskCompletionSource().getTask();
        if (huaweiApi != null) {
            try {
                a(huaweiApi);
    ...
    public PendingIntent getErrPendingIntent(Context context, int i, int i2) {
        ...
        Intent intentA = a(context, i);
        if (intentA != null) {
            return PendingIntent.getActivity(context, i2, intentA, ConnectionsManager.FileTypeFile);
        }
        return null;
    }
    ...
    public Task getHuaweiServicesReady(Activity activity) {
        ...
        Task task = taskCompletionSourceArr[0].getTask();
