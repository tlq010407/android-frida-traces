...
public class v0 extends i0<u, Void> {
    ...
    public void doExecute(u uVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource taskCompletionSource) throws ApiException {
        try {
            HMSLocationLog.i("RemoveGeofencesTaskApiCall", this.a, "remove geofences doExecute");
            ...
            HMSLocationLog.e("RemoveGeofencesTaskApiCall", this.a, "remove geofences doExecute exception:" + e.getMessage());
            taskCompletionSource.setException(e);
        } catch (Exception unused) {
            HMSLocationLog.e("RemoveGeofencesTaskApiCall", this.a, "remove geofences doExecute exception");
