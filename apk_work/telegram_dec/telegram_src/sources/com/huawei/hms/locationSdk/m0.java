...
public class m0 extends i0<t, List<HWLocation>> {
    private Context b;
    ...
    public void doExecute(t tVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource taskCompletionSource) throws ApiException {
        try {
            HMSLocationLog.i("GetFromLocationNameTaskApiCall", this.a, "doExecute");
            ...
            HMSLocationLog.e("GetFromLocationNameTaskApiCall", this.a, "getFromLocationName doExecute exception:" + e.getMessage());
            taskCompletionSource.setException(e);
        } catch (Exception unused) {
            HMSLocationLog.e("GetFromLocationNameTaskApiCall", this.a, "getFromLocationName doExecute exception");
