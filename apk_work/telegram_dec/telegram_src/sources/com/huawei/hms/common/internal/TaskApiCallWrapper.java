...
public class TaskApiCallWrapper<TResult> extends BaseContentWrapper {
    ...
    private final TaskCompletionSource mTaskCompletionSource;

    public TaskApiCallWrapper(TaskApiCall<? extends AnyClient, TResult> taskApiCall, TaskCompletionSource taskCompletionSource) {
        super(1);
