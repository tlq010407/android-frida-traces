...
public abstract class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, MediaController.VIDEO_BITRATE_480, ExceptionCode.CRASH_EXCEPTION, 100000000, 1000000000};
    static final int[] halfPowersOf10 = {3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE};
    private static final int[] factorials = {1, 1, 2, 6, 24, R.styleable.AppCompatTheme_windowFixedHeightMajor, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
