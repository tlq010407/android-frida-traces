...
abstract class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, R.styleable.AppCompatTheme_textAppearancePopupMenuHeader, -1, -1}, new int[]{6, 32, 58, 84, R.styleable.AppCompatTheme_textColorAlertDialogListItem, -1, -1}, new int[]{6, 30, 58, 86, R.styleable.AppCompatTheme_tooltipForegroundColor, -1, -1}, new int[]{6, 34, 62, 90, R.styleable.AppCompatTheme_windowActionBarOverlay, -1, -1}, new int[]{6, 26, 50, 74, 98, R.styleable.AppCompatTheme_windowFixedWidthMajor, -1}, new int[]{6, 30, 54, 78, 102, R.styleable.AppCompatTheme_windowNoTitle, -1}, new int[]{6, 26, 52, 78, 104, NotificationCenter.walletPendingTransactionsChanged, -1}, new int[]{6, 30, 56, 82, 108, 134, -1}, new int[]{6, 34, 60, 86, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle, 138, -1}, new int[]{6, 30, 58, 86, R.styleable.AppCompatTheme_tooltipForegroundColor, 142, -1}, new int[]{6, 34, 62, 90, R.styleable.AppCompatTheme_windowActionBarOverlay, 146, -1}, new int[]{6, 30, 54, 78, 102, R.styleable.AppCompatTheme_windowNoTitle, ImageReceiver.DEFAULT_CROSSFADE_DURATION}, new int[]{6, 24, 50, 76, 102, 128, 154}, new int[]{6, 28, 54, 80, R.styleable.AppCompatTheme_textAppearancePopupMenuHeader, 132, 158}, new int[]{6, 32, 58, 84, R.styleable.AppCompatTheme_textColorAlertDialogListItem, 136, 162}, new int[]{6, 26, 54, 82, R.styleable.AppCompatTheme_textColorAlertDialogListItem, 138, 166}, new int[]{6, 30, 58, 86, R.styleable.AppCompatTheme_tooltipForegroundColor, 142, 170}};
