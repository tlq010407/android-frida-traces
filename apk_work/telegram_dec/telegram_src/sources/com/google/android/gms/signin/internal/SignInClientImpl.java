...
public class SignInClientImpl extends GmsClient implements com.google.android.gms.signin.zae {
    ...
    public final void zad(zae zaeVar) {
        ...
        try {
            ...
            ((zaf) getService()).zag(new zai(1, new zat(accountOrDefault, ((Integer) Preconditions.checkNotNull(this.zae)).intValue(), HuaweiApiClientImpl.DEFAULT_ACCOUNT.equals(accountOrDefault.name) ? Storage.getInstance(getContext()).getSavedDefaultGoogleSignInAccount() : null)), zaeVar);
