...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        ...
        Preconditions.checkArgument(f2 >= com.huawei.hms.maps.model.BitmapDescriptorFactory.HUE_RED && f2 <= 90.0f, "Tilt needs to be between 0 and 90 inclusive: %s", Float.valueOf(f2));
        this.target = latLng;
        this.zoom = f;
        this.tilt = f2 + com.huawei.hms.maps.model.BitmapDescriptorFactory.HUE_RED;
