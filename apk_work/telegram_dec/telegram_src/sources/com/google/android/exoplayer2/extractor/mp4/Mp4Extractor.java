...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) {
        ...
        if (leafAtomOfType != null) {
            ...
            Metadata metadata4 = (Metadata) udta.first;
            Metadata metadata5 = (Metadata) udta.second;
            if (metadata4 != null) {
        ...
        List traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder2, -9223372036854775807L, null, (this.flags & 1) != 0, z, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
        ...
        int size2 = -1;
        while (i4 < size) {
            TrackSampleTable trackSampleTable = (TrackSampleTable) traks.get(i4);
            if (trackSampleTable.sampleCount == 0) {
                ...
                metadata3 = metadata6;
                MetadataUtil.setFormatMetadata(track.type, metadata3, mdtaFromMeta, builderBuildUpon, metadata2, this.slowMotionMetadataEntries.isEmpty() ? null : new Metadata(this.slowMotionMetadataEntries));
    ...
    */
    public SeekMap.SeekPoints getSeekPoints(long j, int i) {
        ...
        if (i2 != -1) {
            ...
            return j4 != -9223372036854775807L ? new SeekMap.SeekPoints(seekPoint) : new SeekMap.SeekPoints(seekPoint, new SeekPoint(j4, jMaybeAdjustSeekOffset));
        }
        j2 = Long.MAX_VALUE;
        j3 = j;
