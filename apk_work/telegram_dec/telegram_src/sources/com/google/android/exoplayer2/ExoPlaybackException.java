...
public final class ExoPlaybackException extends PlaybackException {
    ...
    public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.ExoPlaybackException$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return ExoPlaybackException.m37$r8$lambda$1XKy3W7SelM_FKalWARGECf72M(bundle);
        }
    };
    private static final String FIELD_TYPE = Util.intToStringMaxRadix(1001);
    private static final String FIELD_RENDERER_NAME = Util.intToStringMaxRadix(CommonCode.BusInterceptor.PRIVACY_CANCEL);
    ...
    public static /* synthetic */ ExoPlaybackException m37$r8$lambda$1XKy3W7SelM_FKalWARGECf72M(Bundle bundle) {
