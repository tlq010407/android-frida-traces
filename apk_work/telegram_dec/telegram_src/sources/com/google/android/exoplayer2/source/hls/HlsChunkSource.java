...
class HlsChunkSource {
    ...
    public void getNextChunk(long j, long j2, List list, boolean z, HlsChunkHolder hlsChunkHolder) {
        ...
        Pair nextMediaSequenceAndPartIndex = getNextMediaSequenceAndPartIndex(hlsMediaChunk, z2, playlistSnapshot, initialStartTimeUs2, j2);
        ...
        if (jLongValue >= playlistSnapshot.mediaSequence || hlsMediaChunk == null || !z2) {
            ...
            Pair nextMediaSequenceAndPartIndex2 = getNextMediaSequenceAndPartIndex(hlsMediaChunk, false, playlistSnapshot2, initialStartTimeUs, j2);
