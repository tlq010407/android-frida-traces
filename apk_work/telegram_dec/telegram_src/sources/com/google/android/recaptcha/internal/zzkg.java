...
final class zzkg {
    ...
    */
    private static void zzd(zzke zzkeVar, StringBuilder sb, int i) throws SecurityException {
        int i2;
        Object obj;
        Method method;
        String strSubstring;
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (strSubstring2.endsWith("List") && !strSubstring2.endsWith("OrBuilderList") && !strSubstring2.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                ...
                objZzz = zzit.zzz(method2, zzkeVar, new Object[0]);
                ...
                if (hashSet.contains("set".concat(strSubstring2)) && (!strSubstring2.endsWith("Bytes") || !treeMap.containsKey("get".concat(String.valueOf(strSubstring2.substring(0, strSubstring2.length() - 5)))))) {
                    ...
                    if (method4 != null) {
                        Object objZzz2 = zzit.zzz(method4, zzkeVar, new Object[0]);
                        if (method5 == null) {
                            if (objZzz2 instanceof Boolean) {
                                if (((Boolean) objZzz2).booleanValue()) {
                                    zzb(sb, i, strSubstring2, objZzz2);
                                }
                            } else if (objZzz2 instanceof Integer) {
                                if (((Integer) objZzz2).intValue() != 0) {
                                }
                            } else if (objZzz2 instanceof Float) {
                                if (Float.floatToRawIntBits(((Float) objZzz2).floatValue()) != 0) {
                                }
                            } else if (!(objZzz2 instanceof Double)) {
                                if (objZzz2 instanceof String) {
                                    obj = "";
                                } else if (objZzz2 instanceof zzgw) {
                                    obj = zzgw.zzb;
                                } else if (objZzz2 instanceof zzke) {
                                    if (objZzz2 != ((zzke) objZzz2).zzY()) {
                                    }
                                } else if (!(objZzz2 instanceof Enum) || ((Enum) objZzz2).ordinal() != 0) {
                                }
                                if (!objZzz2.equals(obj)) {
                                }
                            } else if (Double.doubleToRawLongBits(((Double) objZzz2).doubleValue()) != 0) {
                            }
                ...
                objZzz = zzit.zzz(method, zzkeVar, new Object[0]);
            }
