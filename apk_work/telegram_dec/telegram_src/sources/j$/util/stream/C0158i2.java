...
final class C0158i2 extends AbstractC0124a0 {
    final /* synthetic */ long m;
    final /* synthetic */ long n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C0158i2(AbstractC0127b abstractC0127b, int i, long j, long j2) {
    ...
    final G0 t0(Spliterator spliterator, IntFunction intFunction, AbstractC0127b abstractC0127b) {
        ...
        if (jL0 > 0 && spliterator.hasCharacteristics(LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD_NOT_PREMIUM)) {
            return AbstractC0203u0.G(abstractC0127b, AbstractC0203u0.y(abstractC0127b.o0(), spliterator, this.m, this.n), true);
        }
        if (R2.ORDERED.j(abstractC0127b.p0())) {
            return (G0) new C0182o2(this, abstractC0127b, spliterator, intFunction, this.m, this.n).invoke();
        }
        j$.util.G g = (j$.util.G) abstractC0127b.C0(spliterator);
        long j2 = this.m;
        long j3 = this.n;
        if (j2 <= jL0) {
        ...
        return AbstractC0203u0.G(this, new o3(g, j, jMin), true);
    }
    ...
    final Spliterator u0(AbstractC0127b abstractC0127b, Spliterator spliterator) {
        ...
        if (jL0 > 0 && spliterator.hasCharacteristics(LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD_NOT_PREMIUM)) {
            j$.util.G g = (j$.util.G) abstractC0127b.C0(spliterator);
            long j4 = this.m;
            return new i3(g, j4, AbstractC0203u0.x(j4, j3));
        }
        if (R2.ORDERED.j(abstractC0127b.p0())) {
            return ((G0) new C0182o2(this, abstractC0127b, spliterator, new C0136d0(9), this.m, this.n).invoke()).spliterator();
        }
        j$.util.G g2 = (j$.util.G) abstractC0127b.C0(spliterator);
        long j5 = this.m;
        if (j5 <= jL0) {
            long jMin = jL0 - j5;
            if (j3 >= 0) {
    ...
    final InterfaceC0142e2 w0(int i, InterfaceC0142e2 interfaceC0142e2) {
        return new C0154h2(this, interfaceC0142e2);
    }
}
