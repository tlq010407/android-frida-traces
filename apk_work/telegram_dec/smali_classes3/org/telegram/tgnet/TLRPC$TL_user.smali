...
.method public readParams(Lorg/telegram/tgnet/InputSerializedData;Z)V
    ...
    :goto_5
    iput-boolean v4, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_chat_history:Z
    ...
    :goto_6
    iput-boolean v4, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_nochats:Z
    ...
    :goto_7
    iput-boolean v4, p0, Lorg/telegram/tgnet/TLRPC$User;->verified:Z
    ...
    :goto_8
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->restricted:Z
    ...
    :goto_9
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->min:Z
    ...
    :goto_a
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_inline_geo:Z
    ...
    :goto_b
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->support:Z
    ...
    :goto_c
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->scam:Z
    ...
    :goto_d
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->apply_min_photo:Z
    ...
    :goto_e
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->fake:Z
    ...
    :goto_f
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_attach_menu:Z
    ...
    :goto_10
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->premium:Z
    ...
    :goto_12
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_can_edit:Z
    ...
    :goto_13
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->close_friend:Z
    ...
    :goto_14
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->stories_hidden:Z
    ...
    :goto_15
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->stories_unavailable:Z
    ...
    :goto_16
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->contact_require_premium:Z
    ...
    :goto_17
    iput-boolean v5, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_business:Z
    ...
    :cond_18
    iput-boolean v2, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_has_main_app:Z

    invoke-interface {p1, p2}, Lorg/telegram/tgnet/InputSerializedData;->readInt64(Z)J

    move-result-wide v5

    iput-wide v5, p0, Lorg/telegram/tgnet/TLRPC$User;->id:J
    ...
    iput-wide v5, p0, Lorg/telegram/tgnet/TLRPC$User;->access_hash:J
    ...
    iput-wide v2, p0, Lorg/telegram/tgnet/TLRPC$User;->bot_verification_icon:J
    ...
    iput-wide p1, p0, Lorg/telegram/tgnet/TLRPC$User;->send_paid_messages_stars:J
