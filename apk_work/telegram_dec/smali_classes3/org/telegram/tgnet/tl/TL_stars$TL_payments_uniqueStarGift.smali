...
.method public static TLdeserialize(Lorg/telegram/tgnet/InputSerializedData;IZ)Lorg/telegram/tgnet/tl/TL_stars$TL_payments_uniqueStarGift;
    ...
    const v0, -0x355d09f5    # -5339909.5f
    ...
    const-string p1, "can\'t parse magic %x in TL_payments_uniqueStarGift"
    ...
    :cond_1
    new-instance p1, Lorg/telegram/tgnet/tl/TL_stars$TL_payments_uniqueStarGift;

    invoke-direct {p1}, Lorg/telegram/tgnet/tl/TL_stars$TL_payments_uniqueStarGift;-><init>()V

    invoke-virtual {p1, p0, p2}, Lorg/telegram/tgnet/tl/TL_stars$TL_payments_uniqueStarGift;->readParams(Lorg/telegram/tgnet/InputSerializedData;Z)V
