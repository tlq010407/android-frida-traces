...
.method public static TLdeserialize(Lorg/telegram/tgnet/InputSerializedData;IZ)Lorg/telegram/tgnet/tl/TL_stories$TL_foundStory;
    ...
    const-string p1, "can\'t parse magic %x in TL_foundStory"
    ...
    :cond_1
    new-instance p1, Lorg/telegram/tgnet/tl/TL_stories$TL_foundStory;

    invoke-direct {p1}, Lorg/telegram/tgnet/tl/TL_stories$TL_foundStory;-><init>()V

    invoke-virtual {p1, p0, p2}, Lorg/telegram/tgnet/tl/TL_stories$TL_foundStory;->readParams(Lorg/telegram/tgnet/InputSerializedData;Z)V
