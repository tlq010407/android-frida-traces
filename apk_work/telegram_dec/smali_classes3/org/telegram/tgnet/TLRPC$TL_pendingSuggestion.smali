...
.method public static TLdeserialize(Lorg/telegram/tgnet/InputSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$TL_pendingSuggestion;
    ...
    const-string p1, "can\'t parse magic %x in TL_pendingSuggestion"
    ...
    :cond_1
    new-instance p1, Lorg/telegram/tgnet/TLRPC$TL_pendingSuggestion;

    invoke-direct {p1}, Lorg/telegram/tgnet/TLRPC$TL_pendingSuggestion;-><init>()V

    invoke-virtual {p1, p0, p2}, Lorg/telegram/tgnet/TLRPC$TL_pendingSuggestion;->readParams(Lorg/telegram/tgnet/InputSerializedData;Z)V
