...
# direct methods
.method constructor <init>(ILj$/util/Spliterator;Lj$/util/stream/b;)V
    .locals 0
    ...
    iput-object p3, p0, Lj$/util/stream/r1;->b:Lj$/util/stream/b;

    invoke-interface {p2}, Lj$/util/Spliterator;->estimateSize()J

    move-result-wide p2

    invoke-static {p2, p3}, Lj$/util/stream/e;->f(J)J
...
.method constructor <init>(Lj$/util/stream/r1;Lj$/util/Spliterator;JJI)V
    .locals 3
    ...
    iget-object p2, p1, Lj$/util/stream/r1;->b:Lj$/util/stream/b;

    iput-object p2, p0, Lj$/util/stream/r1;->b:Lj$/util/stream/b;
...
# virtual methods
.method abstract a(Lj$/util/Spliterator;JJ)Lj$/util/stream/r1;
.end method
...
.method public final compute()V
    ...
    iget-object v6, p0, Lj$/util/stream/r1;->a:Lj$/util/Spliterator;
    ...
    :cond_0
    iget-object v0, v7, Lj$/util/stream/r1;->b:Lj$/util/stream/b;

    invoke-virtual {v0, v6, v7}, Lj$/util/stream/b;->A0(Lj$/util/Spliterator;Lj$/util/stream/e2;)Lj$/util/stream/e2;
