...
.method private static createAudioTrackBeforeOreo(IIILandroid/media/AudioAttributes;)Landroid/media/AudioTrack;
    ...
    invoke-static {p3, v1}, Lcom/google/android/exoplayer2/audio/AudioCapabilities$Api29$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioFormat$Builder;I)Landroid/media/AudioFormat$Builder;

    move-result-object p3

    invoke-static {p3, p0}, Lcom/google/android/exoplayer2/audio/AudioCapabilities$Api29$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioFormat$Builder;I)Landroid/media/AudioFormat$Builder;
...
.method private static createAudioTrackOnOreoOrHigher(IIILandroid/media/AudioAttributes;)Landroid/media/AudioTrack;
    ...
    invoke-static {v0, p3}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioTrack$Builder;
    ...
    invoke-static {p3, p0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    invoke-static {p0, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    const/4 p1, 0x0

    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    invoke-static {p0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioTrack$Builder;)Landroid/media/AudioTrack;
...
.method private static getAudioAttributes(Landroid/media/AudioAttributes;)Landroid/media/AudioAttributes;
    ...
    invoke-static {p0}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioAttributes;)I
    ...
    :cond_0
    invoke-static {p0}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioAttributes;)I
    ...
    :cond_1
    invoke-static {p0}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioAttributes;)I
...
.method private setStreamVolume(I)Z
    ...
    invoke-static {v0}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioManager;)Z
