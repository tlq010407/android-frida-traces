...
.method constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-static {v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline6;->m(Ljava/lang/Object;)Landroid/media/session/MediaSession$Token;
...
.method public getMetadata()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/session/MediaController;)Landroid/media/MediaMetadata;
...
.method public getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/session/MediaController;)Landroid/media/session/PlaybackState;
...
.method public getQueue()Ljava/util/List;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/session/MediaController;)Ljava/util/List;
...
.method public getSessionActivity()Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/session/MediaController;)Landroid/app/PendingIntent;
...
.method public getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/session/MediaController;)Landroid/media/session/MediaController$TransportControls;
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    invoke-static {v0, v1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/session/MediaController;Landroid/media/session/MediaController$Callback;Landroid/os/Handler;)V
...
.method public sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline8;->m(Landroid/media/session/MediaController;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public final unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/session/MediaController;Landroid/media/session/MediaController$Callback;)V
