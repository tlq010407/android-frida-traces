...
.method public onAudioInfoChanged(Landroid/media/session/MediaController$PlaybackInfo;)V
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/session/MediaController$PlaybackInfo;)I

    move-result v2

    invoke-static {p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/session/MediaController$PlaybackInfo;)Landroid/media/AudioAttributes;
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/session/MediaController$PlaybackInfo;)I

    move-result v4

    invoke-static {p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/session/MediaController$PlaybackInfo;)I

    move-result v5

    invoke-static {p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/session/MediaController$PlaybackInfo;)I
