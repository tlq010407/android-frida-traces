...
.method private createAudioTrackV29(ZLcom/google/android/exoplayer2/audio/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    invoke-static {p2, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    const/4 p2, 0x1

    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    iget v0, p0, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration;->bufferSize:I

    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1, p3}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    :goto_0
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioTrack$Builder;)Landroid/media/AudioTrack;
