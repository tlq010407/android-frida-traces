...
.method private static alignVideoSizeV21(Landroid/media/MediaCodecInfo$VideoCapabilities;II)Landroid/graphics/Point;
    ...
    .line 0
    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline8;->m(Landroid/media/MediaCodecInfo$VideoCapabilities;)I

    move-result v0

    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/MediaCodecInfo$VideoCapabilities;)I
...
.method private static areSizeAndRateSupportedV21(Landroid/media/MediaCodecInfo$VideoCapabilities;IID)Z
    ...
    invoke-static {p0, p2, p1, p3, p4}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/MediaCodecInfo$VideoCapabilities;IID)Z
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p2, p1}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/MediaCodecInfo$VideoCapabilities;II)Z
...
.method private static estimateLegacyVp9ProfileLevels(Landroid/media/MediaCodecInfo$CodecCapabilities;)[Landroid/media/MediaCodecInfo$CodecProfileLevel;
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaCodecInfo$CodecCapabilities;)Landroid/media/MediaCodecInfo$VideoCapabilities;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/MediaCodecInfo$VideoCapabilities;)Landroid/util/Range;
...
.method public alignVideoSizeV21(II)Landroid/graphics/Point;
    ...
    :cond_0
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaCodecInfo$CodecCapabilities;)Landroid/media/MediaCodecInfo$VideoCapabilities;
...
.method public isAudioChannelCountSupportedV21(I)Z
    ...
    :cond_0
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/MediaCodecInfo$CodecCapabilities;)Landroid/media/MediaCodecInfo$AudioCapabilities;
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/MediaCodecInfo$AudioCapabilities;)I
...
.method public isAudioSampleRateSupportedV21(I)Z
    ...
    :cond_1
    invoke-static {v0, p1}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/MediaCodecInfo$AudioCapabilities;I)Z
